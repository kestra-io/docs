...
For the deeper category-specific guides, see [data orchestration](/resources/data/data-orchestration) (the most common tech usage), workflow management (for operations teams), the [infrastructure automation page](/infra-automation) (for DevOps), and [RAG pipeline orchestration](/resources/ai/rag-pipeline) (for AI). For the product view, [Kestra](/) is an open-source orchestration platform that covers data, AI, and infrastructure workflows from one engine. For the architectural case behind coordinating all of those domains on one control plane, see [unified orchestration](/resources/orchestration/unified-orchestration) and the [unified orchestration whitepaper](/resources/whitepapers/unified-orchestration).
