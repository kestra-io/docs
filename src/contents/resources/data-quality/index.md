...
- **Test Coverage:** Assertions belong next to the transformation that produces the data. For the built-in generic tests and when to write custom ones, see [dbt tests explained](/resources/data/dbt-tests-explained).
