...
-   **Rich Plugin Ecosystem:** With hundreds of [core plugins](https://kestra.io/plugins/core) and integrations for tools like [Google Cloud Monitoring](https://kestra.io/plugins/plugin-gcp), you can pull in observability data from across your stack.
