...
description: Navigate the Kestra User Interface. A guide to the main UI components including Flows, Executions, Logs, and Administration pages.
...
The [Kestra Enterprise Edition](../oss-vs-paid/index.md) comes with additional functionalities provided by the Kestra UI:
...
- The **Administration** tab has additional Enterprise sections.
- **IAM** lets you manage Users, Groups, and Roles.
- **Audit Logs** gives access to Kestra audit logs.
- **Instance** provides an overview of Kestra server component statuses, announcements, and maintenance mode.
- **Tenants** lets you manage your tenants and is accessible only to users with admin permissions.
