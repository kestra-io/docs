...
The tour walks through creating and executing a first flow.
...
The sidebar is customizable from **Settings → Preferences → Customize Sidebar** — items can be reordered or hidden.
