...
If you have flows that write to assets across namespace boundaries, ensure the flow's namespace is listed in the target namespace's [`allowedNamespaces`](../07.namespace-management/index.md#allowed-namespaces) configuration. Flows that previously bypassed this check may start failing after upgrading.
