...
Customize the catalog's title, colors, and banner image to match your organization's look and feel. Go to **Settings → Super Admin**, then in the left sidebar under your tenant, click **Apps Catalog**.
