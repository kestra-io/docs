...
To create a User with a Superadmin privilege from the [CLI](../../../server-cli/index.mdx), use the `--superadmin` option:
...
To set an existing User with a Superadmin privilege from the [CLI](../../../server-cli/index.mdx), use the dedicated command:
