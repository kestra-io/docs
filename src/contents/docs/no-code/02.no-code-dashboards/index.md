...
h1: Build Interactive Dashboards Without Writing YAML
...
## Create dashboards with the No Code editor
...
For more example charts, see the [Dashboards documentation page](../../09.ui/00.dashboard/index.md#create-a-new-custom-dashboard-as-code).
