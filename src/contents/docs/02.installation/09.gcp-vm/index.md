...
![vm creation_1](./vm_setup1.png)

![vm creation 2](./vm_setup2.png)

![change_boot_disk_image](./vm_setup3.png)

![vm_creation_3](./vm_setup4.png)
...
![vm_network_details_option](./vm_network_details_option.png)

![vm_network_interface_details](./vm_network_interface_details.png)

![vm_firewall_policies](./vm_firewall_policies.png)

![vm_create_firewall_rule](./vm_create_firewall_rule.png)
...
![db_choices](./db_choices.png)

![db_setup](./db_setup.png)

![db_show_config](./db_show_config_options.png)
...
![db_connections](./db_connections.png)

![db_enable_api](./db_enable_api.png)

![db_auto_allocate](./db_auto_allocate.png)

![db_auto_allocate](./db_create_connection.png)
...
![db_deletion_protection](./db_deletion_protection.png)
...
![db_users](./db_users.png)

![db_user_creation](./db_user_creation.png)
