...
:::alert{type="info"}
**Using an AI coding agent?** Claude Code, Cursor, Codex, and similar tools can generate and deploy Kestra flows once you connect them to the Kestra MCP server and Agent Skills. See [AI tools](../ai-tools/index.mdx) for every option — useful throughout this tutorial and beyond.
:::
