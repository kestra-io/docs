...
## Install script dependencies at runtime
...
To run languages other than Python directly with the [Process Task Runner](../../task-runners/04.types/01.process-task-runner/index.md) you need to install it before executing the code. Here is an example using Go:
