...
Here's an example of the Docker Task Runner configured to use the `ubuntu` container image:
...
You can learn more in the [Docker Task Runner documentation](../../task-runners/04.types/02.docker-task-runner/index.md).
...
You can learn more in the [Process Task Runner documentation](../../task-runners/04.types/01.process-task-runner/index.md).

Find out more information on the dedicated [Task Runners](../../task-runners/index.mdx) documentation.
