...
3. **Dynamic Scaling** – [Task runners](../07.enterprise/04.scalability/task-runners.md) provision resources on-demand (AWS ECS Fargate, Google Batch) for heavy workloads.
...
1. **Install Kestra** – Follow the [quick start guide](../01.quickstart/index.md) or [production setup](../02.installation/index.md).
...
4. **Observe** – Monitor execution logs, outputs, and metrics in [Kestra’s UI](../09.ui/index.md).
