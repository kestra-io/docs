...
## Orchestrate dbt projects with Kestra
...
![dbt-code-editor](../../15.how-to-guides/dbt/dbt-code-editor.png)
...
![dbt-code-editor](../../15.how-to-guides/dbt/dbt-code-editor-2.png)
...
Once you are satisfied with the changes, you can push them to the same Git repository to your desired Git branch using the [PushNamespaceFiles](../../15.how-to-guides/pushnamespacefiles/index.md).
...
2. **Write Your Workflows** – Configure your [flow](../../03.tutorial/index.mdx) in YAML, declaring inputs, tasks, and triggers. Use one of the patterns above to sync dbt projects from Git, run dbt CLI commands, and push changes back to Git.
...
- [Read how-to guide on dbt](../../15.how-to-guides/dbt/index.md)
