...
![Bulk Resume](../../15.how-to-guides/pause-resume/pause_resume2.png)
...
2. **Write Your Workflows** – Configure your [flow](../../03.tutorial/index.mdx) in YAML. Each automated task can invoke an API, run scripts, or call any existing service. Then, add `Pause` tasks for manual approvals:
   ```yaml
   - id: approval_gate
     type: io.kestra.plugin.core.flow.Pause
     onResume:
...
3. **Configure Notifications** – Use Slack, Teams, or Email plugins to notify users about pending approvals:
   ...
   ```
4. **Add Triggers** – Use scheduled or event-based [triggers](../../05.workflow-components/07.triggers/index.mdx) to launch workflows.
5. **Observe and Manage** – Use [Kestra’s UI](../../09.ui/index.mdx) to monitor states, logs, outputs, and metrics. Correct and replay failed workflow executions or roll back to a previous revision when needed.
...
- [Check How-to Guides](../../15.how-to-guides/pause-resume/index.md) for detailed examples of approval workflows
