...
## Orchestrate microservices with Kestra
...
Kestra can:
- [Trigger](../../05.workflow-components/07.triggers/index.mdx) your microservices from any event, schedule, or flow dependency
- Pass data of any size between services thanks to built-in [internal storage](../../08.architecture/data-components/index.md#internal-storage)
...
2. **Write Your Workflows** – Configure your [flow](../../03.tutorial/index.mdx) in YAML. Each task can invoke an API, run scripts, or call any existing service.
3. **Add Triggers** – Use scheduled or event-based [triggers](../../05.workflow-components/07.triggers/index.mdx) to start microservice workflows.
4. **Observe and Manage** – Use [Kestra’s UI](../../09.ui/index.mdx) to monitor states, logs, and metrics. Rerun failed workflow executions or roll back with one click.
