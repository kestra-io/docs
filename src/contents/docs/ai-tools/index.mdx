---
title: "AI Tools in Kestra: Copilot, Agents & RAG Workflows"
h1: Accelerate Orchestration with Kestra AI Copilot and Agents
...
Kestra provides AI-powered features — **AI Copilot**, **AI Agents**, and **MCP Server** — that extend how workflows can be created and executed. Additionally, **Agent Skills** let you bring Kestra expertise to external AI coding agents.
...
AI Copilot, AI Agents, and MCP Server are built into Kestra, while Agent Skills extend Kestra expertise to the external tools you already use.
