...
:::alert{type="info"}
The old `conditions` list is deprecated in Kestra 2.0 but still functional. Migrate to `when` at your earliest convenience. See the [trigger conditions migration guide](../../11.migration-guide/v2.0.0/trigger-conditions-redesign/index.md) for before/after examples.
:::
