...
version: ">= 0.18.0"
editions: ["EE", "Cloud"]
description: Execute tasks using Google Batch to provision and manage compute resources on Google Cloud efficiently.
---
...
![project](../../04.types/08.google-cloudrun-task-runner/project.png)

Once created, ensure your new project is selected in the top navigation bar.

![project_selection](../../04.types/08.google-cloudrun-task-runner/project-selection.png)
...
![bucket](../../04.types/08.google-cloudrun-task-runner/bucket.png)
