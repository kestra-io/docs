...
:::alert{type="info"}
For a full list of available properties, see the [AWS plugin documentation](/plugins/plugin-ee-aws/aws-task-runners/io.kestra.plugin.ee.aws.runner.batch) or view them in the built-in Code Editor.
:::
