...
On top of that, we need to specify the namespace that these flows will be deployed to. We can only choose one namespace meaning if we want to deploy multiple namespaces, we will need to add multiple steps using the Deploy Action.
