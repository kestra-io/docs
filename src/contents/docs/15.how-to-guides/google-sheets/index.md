...
![sheet_import](./sheet_import.png)

![sheet_upload](./sheet_upload.png)

![sheet_import_data](./sheet_import_data.png)

![sheet_uploaded_data](./sheet_uploaded_data.png)
...
![create_service_account_1](./create_service_account_1.png)
...
![gsheet_read_output](./gsheet_read_output.png)

This is how Kestra's Google Workspace plugin can be used to read the spreadsheet with its Sheet's [`Read`](/plugins/plugin-googleworkspace/google-sheets/io.kestra.plugin.googleworkspace.sheets.read) task.
