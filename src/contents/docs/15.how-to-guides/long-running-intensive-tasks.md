...
Kestra offers various task execution solutions such as Docker, local processes, and Kubernetes. See [Task Runners](../07.enterprise/04.scalability/task-runners.md) for more details.
