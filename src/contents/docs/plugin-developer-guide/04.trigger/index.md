...
Here is how you can develop a [Trigger](../../05.workflow-components/07.triggers/index.mdx).

## Develop a trigger plugin for Kestra
...
Remember to document your triggers. For this, we provide a set of annotations explained in the [Document each plugin](../07.document/index.md) section.
