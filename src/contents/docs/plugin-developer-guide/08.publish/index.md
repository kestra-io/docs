...
## Build and publish your Kestra plugin

Start by building the plugin locally before publishing it.
...
To use this plugin in your Kestra instance, add this JAR to the [Kestra plugins path](../../server-cli/index.mdx#plugin-commands).
