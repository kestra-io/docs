---
title: LocalFiles & outputDir Deprecated in Kestra 0.17.0
h1: Migrate from LocalFiles and outputDir to inputFiles and outputFiles
sidebarTitle: LocalFiles Deprecated
...
The `LocalFiles` and `outputDir` are deprecated due to overlapping functionality that already exists using `inputFiles` and `outputFiles` on the `WorkingDirectory` and [script](../../../16.scripts/index.mdx) tasks.
