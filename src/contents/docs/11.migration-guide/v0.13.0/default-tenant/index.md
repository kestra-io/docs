...
release: 0.13.0
editions: ["EE", "Cloud"]
description: Instructions for syncing user access to the default tenant following the introduction of multitenancy in Kestra 0.13.0.
---
...
In the [v0.13.0 release](../../../../blogs/2023-11-16-release-0-13/index.md), Kestra introduced multitenancy. As a result, user access is now managed at the tenant level.
