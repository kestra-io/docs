---
title: Kestra 0.23.0 Migration Guide – Mandatory Multitenancy
h1: What Changed in Kestra 0.23.0 and How to Migrate
...
- [Open Source](./tenant-migration-oss/index.md)
- [Enteprise](./tenant-migration-ee/index.md)
  :::
