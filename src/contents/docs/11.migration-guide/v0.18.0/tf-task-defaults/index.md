...
In the [v0.17.0 release](../../../../blogs/2024-06-04-release-0-17/index.md), Task Defaults was renamed to [Plugin Defaults](/docs/migration-guide/v2.0.0/plugin-defaults-removed) to better reflect its purpose. As a result, the 0.18.0 version of the [Terraform Provider](../../../13.terraform/index.mdx) now uses the property `plugin_defaults` instead of `task_defaults` in the `kestra_namespace` resource.
