...
![Step 1 - Docker](./clever-cloud-step-1-docker.png)
...
![Step 2 - Docker](./clever-cloud-step-2-docker.png)
...
- `KESTRA_CONFIGURATION` to the Kestra [configuration](../../docs/configuration/index.mdx) YAML file.
...
5. As the Docker engine is not accessible from the Kestra container, we configure globally the `Process` [task runner](../../docs/task-runners/index.mdx) for all plugins using [Plugins Default](../../docs/05.workflow-components/09.plugin-defaults/index.md).
...
![Step 4 - Docker](./clever-cloud-step-4-docker.png)
...
![Step 7 - Cellar](./clever-cloud-step-7-cellar.png)
...
![Step 8 - Cellar](./clever-cloud-step-8-cellar.png)
...
![Step 9 - PostgreSQL](./clever-cloud-step-9-postgres.png)
...
![Step 10 - PostgreSQL](./clever-cloud-step-10-postgres.png)
...
![Step 11 - PostgreSQL](./clever-cloud-step-11-postgres.png)
...
![Step 12 - PostgreSQL](./clever-cloud-step-12-postgres.png)
...
![Step 13 - Kestra](./clever-cloud-step-13-kestra.png)
