...
5. As the Docker engine is not accessible from the Kestra container, we configure globally the `Process` [task runner](../../docs/task-runners/index.mdx) for all plugins using a static [Policy](../../docs/enterprise/governance/policies/index.md).
