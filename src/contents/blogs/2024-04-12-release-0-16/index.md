...
Kestra 0.16.0 introduces a new `taskRunner` property in Beta, offering more flexibility than  `runner` and allows you to deploy your code to various remote environments, including [Kubernetes](/plugins/plugin-ee-kubernetes/io.kestra.plugin.ee.kubernetes.runner.kubernetes), [Docker](/plugins/core/docker-task-runner/io.kestra.plugin.scripts.runner.docker.docker),
 [AWS Batch](/plugins/plugin-ee-aws/aws-batch-task-runner/io.kestra.plugin.ee.aws.runner.batch), [Azure Batch](/plugins/plugin-ee-azure/azure-runner/io.kestra.plugin.ee.azure.runner.batch), [Google Batch](/plugins/plugin-ee-gcp/google-cloud-task-runner/io.kestra.plugin.ee.gcp.runner.batch), and more coming in the future. Since each `taskRunner` type is a plugin, you can create your own, fully tailored to your needs.
...
<div>
  <iframe width="700" height="400" src="https://www.youtube.com/embed/ynIYqMC1T00?si=dsq7wTEjUn1kO8Z9" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
![better_trigger_display](./better_trigger_display.png)
...
![cluster_health_dashboard](./cluster_health_dashboard.png)
