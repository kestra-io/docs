...
To go further between the integration of DuckDB and Kestra you can check our article on [how to automate your data analyse using kestra and DuckDB](../2023-04-25-automate-data-analysis-with-kestra-and-duckdb/index.md) or check out our article about [when you need to move from DuckDB to MotherDuck](../duckdb-vs-motherduck/index.md)
