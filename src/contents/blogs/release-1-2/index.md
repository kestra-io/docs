...
- **Improved Liveness & Grace Period** – The liveness mechanism has been upgraded with timeout-based detection and enhanced documentation. There is now explicit, configurable support for termination grace periods. Refer to the [configuration documentation](../../docs/configuration/index.mdx) for more information.
