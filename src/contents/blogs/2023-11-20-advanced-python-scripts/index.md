...
![Image 3 - Running the Python script](./3.png)
...
![Image 5 - Contents of a GitHub repo](./5.png)
...
![Image 6 - Contents of the Kestra editor](./6.png)
...
![Image 7 - Running the Kestra flow](./7.png)
...
![Image 8 - Kestra flow logs](./8.png)
...
![Image 10 - Reruning the Kestra flow](./10.png)
...
![Image 13 - Adding the script file](./13.png)
...
![Image 16 - Examining the logs](./16.png)
...
Make sure to **stay tuned** to the [Kestra blog](/blogs) for more up-to-date guides on orchestration, automation tools, trends in data management, and new features related to our Kestra orchestration platform.
