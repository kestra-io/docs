...
| Dashboards moved to the Enterprise Edition | The `SyncDashboards` and `PushDashboards` tasks are removed from the Git plugin and will be available in the Git EE plugin. Remove them from your flows before upgrading. |
