...
- **Browse real workflows.** Kestra's [390+ Blueprints](/blueprints) are production-ready workflow templates written in YAML. A few worth reading to see the orchestration/execution separation in practice:
