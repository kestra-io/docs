...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/nYu6_6Bj7hs?si=V-KtcXywLY7cle_C" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
![old_vs_new_dashboard](./old_vs_new_dashboard.png)
...
![new_dashboard_purple](./new_dashboard_purple.png)
...
![system_namespace](./system_namespace.png)
...
![system_blueprints](./system_blueprints.png)

Video version:

<div class="video-container">
  <iframe src="https://www.youtube.com/embed/Y8OhRFGCV3A?si=jw-VsFDdVutDObhL" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
![system_filter](./system_filter.png)
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/o05hcKNI_7I?si=fo8XuY6yVTmUTykb" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
![loglevel_display](./loglevel_display.png)
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/7Yz0N_26lDY?si=Vyy5ETE384wHflaK" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
Check the [Worker Group](../../docs/07.enterprise/04.scalability/worker-group/index.md) documentation to learn how to create and manage worker groups.
...
![permissions_tree_view](./permissions_tree_view.png)
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/DSLNd7L3LR4?si=1hhh5b8tWQDXA5bh" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>

You can type the desired date directly, or use the date picker and click on the `Execute` button.

![execute_later](./execute_later.png)
...
![execute_later2](./execute_later2.png)
