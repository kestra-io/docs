...
| OAuth token tasks for AWS and Azure              | Fetch OAuth tokens that you can use along with the [Kubernetes task runner](../../docs/task-runners/04.types/03.kubernetes-task-runner/index.md).                                              | All editions |
...
![storageSecretsPerTenant.png](./storageSecretsPerTenant.png)
