...
![Before](./executor-cpu-before.png)
<p class="figure-caption text-center">Before</p>

![After](./executor-cpu-after.png)
...
![Before](./queue-before.png)
<p class="figure-caption text-center">Before</p>

![After](./queue-after.png)
<p class="figure-caption text-center">After</p>
...
![Before](./executor-duration-before.png)
<p class="figure-caption text-center">Before</p>

![After](./executor-duration-after.png)
<p class="figure-caption text-center">After</p>
...
```
In this example, we read a table from a mysql database using a [Query](/plugins/plugin-jdbc-mysql/io.kestra.plugin.jdbc.mysql.query)  and store it on internal storage, after generating a [bulk insert](/plugins/plugin-jdbc-sqlserver/io.kestra.plugin.jdbc.sqlserver.batch) that will load the resulting dataset into a Microsoft SQL Server database.
...
## Kafka
The Kafka plugin is now also released with a first [Produce](/plugins/plugin-kafka/io.kestra.plugin.kafka.produce) (Consume will come soon).  Like the other plugins (jdbc, json, csv, ...), the Kafka plugins rely on Kestra's internal storage, allowing you to send from any source to Kafka.
...
<video controls="true" allowfullscreen="true">
  <source src="./deps.mp4" type="video/mp4">
</video>
...
![Kestra user interface](./deps.png)
