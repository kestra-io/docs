...
![namespaces_before_0_18](./namespaces_before_0_18.png)
...
![namespaces_after_0_18](./namespaces_after_0_18.png)
...
![secrets_enhancements](./secrets_enhancements.png)
...
![realtime_trigger_ui](./realtime_trigger_ui.png)
...
![temporal_default_logs](./temporal_default_logs.png)

The GIF below shows how you can switch between both views:

![temporal_default_logs](./temporal.gif)
...
![subflow_links](./subflow_links.png)
...
Check the [core plugin documentation](/plugins/core/v1.3.38/flow/io.kestra.plugin.core.flow.foreach) to learn more.
...
![humanized_cron](./humanized_cron.png)
...
![delete_execution](./delete_execution.png)
