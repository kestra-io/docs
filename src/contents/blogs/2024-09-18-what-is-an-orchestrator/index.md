...
![Orchestration vs Automation Diagram by Federico Trotta](./automation_orchestration.png)
...
![Namespaces in Kestra - by Federico Trotta](./tutorial.png)

Under **Editor**, click on **Create file** and give it a name and an extension. For example, let's call it `process_data.py`:

![Adding a new file in Kestra - by Federico Trotta](./new_file.png)
