...
You can find more information about the secret function used in the above example in the [dedicated documentation](../../docs/07.enterprise/02.governance/secrets-manager/index.md).
