...
The JDBC queues table stores internal queue messages. Previously, the [JDBC Cleaner](../../docs/configuration/02.runtime-and-storage/index.md#connection-pooling-and-jdbc-queue-tuning) only periodically cleaned the table. The default configuration was to clean the table each hour and keep 7 days of messages.
