...
![Gemini task outputs for a multimodal completion with a text](./text-completion-outputs.png)
...
![Gemini task outputs for a multimodal completion with an image](./image-completion-output.png)
...
![Gemini task outputs for a multimodal completion with a video](./video-completion-output.png)
...
![Gemini task outputs for a blocked answer due to safety reason](./safety-blocked-output.png)
