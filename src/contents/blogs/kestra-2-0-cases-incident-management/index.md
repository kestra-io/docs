...
Cases, [Policies](https://kestra.io/docs/enterprise/governance/policies), and [Promote](https://kestra.io/docs/enterprise/governance/promote) are three answers to the same question: how do you govern what runs in production? That is what it means to move from a workflow tool to a platform you run production on.
