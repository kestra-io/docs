---
title: "Kestra Blueprints: Curated Workflow Examples to Get Started Fast"
description: "Explore Kestra's library of 200+ workflow blueprints. This guide walks through the most useful examples for integrating your code, pulling from Git, scaling in the cloud, and setting up alerts."
...
With this simple workflow using the [Slack plugin](/plugins/plugin-slack), we can easily add this to any of our workflows, and incorporate data generated by tasks using expressions.
...
This is just the start of some of the areas you can explore in Kestra to integrate into your existing solution. I'd recommend checking out the full [Blueprint library](/blueprints) for over 200 curated examples. If you build any useful examples, feel free to contribute back by making a Pull Request on our [GitHub repository](https://github.com/kestra-io/blueprints)!
