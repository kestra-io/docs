...
You can [try Kestra locally](../../docs/01.quickstart/index.md) in minutes with Docker, deploy via cloud marketplaces ([AWS](https://aws.amazon.com/marketplace/pp/prodview-uilmngucs45cg) and [Azure](https://marketplace.microsoft.com/en-us/product/AzureApplication/kestra_technologies.kestra-open-source-official)), or start immediately with [Kestra Cloud](https://kestra.io/cloud).