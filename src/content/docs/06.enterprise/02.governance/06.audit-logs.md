...
![audit_logs](assets/docs/concepts/audit_logs.png)
...
![audit_logs](assets/docs/enterprise/audit_logs/audit_log_5.png)
...
![audit_logs](assets/docs/enterprise/audit_logs/audit_log_1.png)

To further filter for a specific event, you can click on the relevant tag in the `Details` column:

![audit_logs](assets/docs/enterprise/audit_logs/audit_log_2.png)
...
![audit_logs](assets/docs/enterprise/audit_logs/audit_log_3.png)
...
![audit_logs](assets/docs/enterprise/audit_logs/audit_log_4.png)
