...
![template-vs-subflow](assets/docs/migration-guide/template-vs-subflow.png)
...
![Kestra User Interface Templates Page](assets/docs/user-interface-guide/06-Templates.png)

A **Template** page allows to edit the template via a YAML editor.

![Kestra User Interface Template Page](assets/docs/user-interface-guide/07-Templates-Template.png)
