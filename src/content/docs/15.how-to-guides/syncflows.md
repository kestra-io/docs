...
![git1](@assets/docs/how-to-guides/syncflows/git1.png)
...
![git2.png](@assets/docs/how-to-guides/syncflows/git2.png)

We can also see a full list inside of the Outputs tab too:

![git3.png](@assets/docs/how-to-guides/syncflows/git3.png)
...
![git4.png](@assets/docs/how-to-guides/syncflows/git4.png)

We can also verify this with the Outputs tab too:

![git5.png](@assets/docs/how-to-guides/syncflows/git5.png)
...
![webhook1.png](@assets/docs/how-to-guides/syncflows/webhook1.png)
...
![webhook2.png](@assets/docs/how-to-guides/syncflows/webhook2.png)
