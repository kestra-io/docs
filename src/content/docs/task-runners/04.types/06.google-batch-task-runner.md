...
![project](assets/docs/concepts/taskrunner-gcp-batch/project.png)

Once you've done this, make sure your project is selected in the menu bar.

![project_selection](assets/docs/concepts/taskrunner-gcp-batch/project-selection.png)
...
![batchapi](assets/docs/concepts/taskrunner-gcp-batch/batchapi.png)
...
![api-credentials-1](assets/docs/concepts/taskrunner-gcp-batch/api-credentials-1.png)
...
![sa-1](assets/docs/concepts/taskrunner-gcp-batch/sa-1.png)
...
![roles](assets/docs/concepts/taskrunner-gcp-batch/roles.png)
...
![create-key](assets/docs/concepts/taskrunner-gcp-batch/create-key.png)
...
![compute](assets/docs/concepts/taskrunner-gcp-batch/compute.png)
...
![bucket](assets/docs/concepts/taskrunner-gcp-batch/bucket.png)
...
![logs](assets/docs/concepts/taskrunner-gcp-batch/logs.png)

We can also go to the GCP Console and see our task runner has been created:

![batch-jobs](assets/docs/concepts/taskrunner-gcp-batch/batch-jobs.png)
...
![outputs](assets/docs/concepts/taskrunner-gcp-batch/outputs.png)
