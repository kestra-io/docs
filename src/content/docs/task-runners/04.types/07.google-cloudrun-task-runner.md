...
![batchapi](assets/docs/concepts/taskrunner-gcp-cloudrun/cloudrunapi.png)
...
![sa-1](assets/docs/concepts/taskrunner-gcp-cloudrun/sa-1.png)
...
![roles](assets/docs/concepts/taskrunner-gcp-cloudrun/roles.png)
...
![compute](assets/docs/concepts/taskrunner-gcp-cloudrun/compute.png)
...
![logs](assets/docs/concepts/taskrunner-gcp-cloudrun/logs.png)

We can also go to the GCP Console and see our task runner has been created:

![jobs](assets/docs/concepts/taskrunner-gcp-cloudrun/jobs.png)
