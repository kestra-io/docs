...
author:
  name: Anna Geller
  image: "ageller"
image: "@assets/blogs/2024-02-29-release-0-15.png"
---
...
![trigger_toggle](@assets/blogs/2024-02-29-release-0-15/trigger_toggle.png)
...
![parent_flow_kill_behavior](@assets/blogs/2024-02-29-release-0-15/parent_flow_kill_behavior.png)
...
![secrets_delete_sensitive_logs](@assets/blogs/2024-02-29-release-0-15/secrets_delete_sensitive_logs.png)
...
![Stats Page](@assets/blogs/2024-02-29-release-0-15/stats_ee.png)
...
![basic_auth](@assets/docs/user-interface-guide/stats_oss.png)
...
![ui_changes_in_0_15](@assets/blogs/2024-02-29-release-0-15/ui_changes_in_0_15.png)

Lastly, the `Save` and `Actions` buttons have been moved to a dedicated UI menu for improved navigation:

![editor_display](@assets/blogs/2024-02-29-release-0-15/editor_display.png)
...
![ee_setup_page](@assets/blogs/2024-02-29-release-0-15/ee_setup_page.png)
...
![access_page](@assets/blogs/2024-02-29-release-0-15/access_page.png)
