<template>
    <GradientCard class="card-block">
        <div v-for="(feat, index) of features" class="block-content">
            ...
            <h3 :style="{ textDecorationColor: feat.color }">
                {{ feat.name }}
            </h3>
...
<script setup lang="ts">
    ...
    import cube from "~/components/home/assets/features-cube.svg"
    import kestraLogo from "~/components/home/assets/features-kestra.svg"
