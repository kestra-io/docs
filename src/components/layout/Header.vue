<template>
    <nav id="top-bar" ref="navbar" class="navbar navbar-expand-lg fixed-top"
        :class="{ open: isOpen, scrolled: isScrolled || props.scrolled, dark: isStories }">
        <div class="container-xl">
            <a class="navbar-brand" href="/" @click="logoClick" @contextmenu.prevent="showDownloadLogosModal">
            ...
            <div class="nav-items d-flex align-items-center">
                ...
                <button class="navbar-toggler d-flex d-lg-none align-items-center gap-2" @click="globalClick(isOpen)"
                    type="button" data-bs-toggle="collapse" data-bs-target="#main-header" aria-controls="main-header"
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-5">
                    <li class="nav-item dropdown" @mouseover="mouseOver('product')" @mouseleave="mouseOut('product')">
                        <a class="nav-link dropdown-toggle" href="#" role="button"
                            :data-bs-toggle="isMobile ? 'dropdown' : undefined" aria-expanded="false">
                            Product
                        ...
                        <div class="dropdown-menu pb-1 d-lg-none">
                            <ul class="dropdown-column">
                                <li v-for="item in menuItems.product.items" :key="item.link">
                                    <a class="dropdown-item" :href="item.link" @click="globalClick(true)">
                                        <div class="item-row">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/plugins" role="button" @click="globalClick(true)">
                            <span>Plugins</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle" href="/pricing" role="button"
        ...
        <div class="d-lg-block d-none menu-container" :style="{ opacity: showMenu || mouseoverMenu ? 100 : 0 }">
            ...
            <div class="menu-shadow-container">
                ...
                }" class="header-menu" @mouseover="mouseOverMenu" @mouseleave="mouseLeaveMenu">
