<template>
	<section class="main-header">
		<div class="hero container">
			...
			<div
				class="d-flex align-self-start align-self-sm-center align-items-sm-center flex-column top"
			>
...
<script setup lang="ts">
	...
	const companiesCarousel = computed(() => [
		...companies.value,
		...companies.value,
		...companies.value,
	])
	...
	.main-header {
		...
		.background {
			...
			@include media-breakpoint-up(lg) {
				background-image:
					url("/landing/infrastructure/bg-ks.png"),
					url("/landing/infrastructure/hero-bg.webp");
				background-position:
					0% 0%,
					top center;
				background-size:
