    ...
    <section class="ready">
        <div class="container">
            ...
            <p data-usal="fade-u delay-200">
                Teams replace vRO, AutoSys, Cron, Jenkins, and manual scripts with Kestra, without
...
<style lang="scss" scoped>
    ...
    .ready {
        ...
        .container {
            ...
            .logo-bg {
                background: url("/landing/infrastructure/logo-bg.png") no-repeat center center;
