            ...
            <div class="row align-items-center" data-usal="fade-u delay-0 duration-500 ease-out">
                <div class="col-12 col-xl-6">
                    <h1>
                        ...
                        <span class="indent"> & <span class="highlight">ITSM</span> Orchestration</span>
                    </h1>
                </div>

                <div class="col-12 col-xl-6">
                    <p>
                        Kestra wraps your automation in enterprise governance and syncs it bi-directionally with your service desk for a secure, fully tracked lifecycle.
                    </p>
                </div>
            </div>
