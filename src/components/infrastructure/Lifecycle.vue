    ...
    <section class="lifecycle">
        <div class="container">
            <div class="row align-items-center" data-usal="fade-u delay-0 duration-500 ease-out">
                <div class="col-12 col-xl-6">
                    <h1>
                        ...
                        <span class="indent">
                            &
                            <span class="highlight">ITSM</span>
                            Orchestration</span
                        >
                    </h1>
                </div>
            ...
            <div class="new-section d-flex flex-column flex-xl-row">
                ...
                <div
                    class="card-item purple-bg"
                    data-usal="slide-l delay-100 duration-600 ease-out"
                >
            ...
            <a to="/demo" class="btn btn-primary btn-gradient"> Talk to us </a>
        </div>
    </section>
</template>
