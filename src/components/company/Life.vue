...
<script setup lang="ts">
	const lifeCards = [
		...
		},
		{
			...
			description:
				"We've got you covered — from health benefits to home office costs and the latest tools, so you can focus on what matters most: doing great work and growing with us.",
		},
		{
			id: 5,
			type: "image-card",
	...
	.container {
		...
		&::before {
			...
			background: linear-gradient(
				180deg,
				transparent 0%,
				rgba(23, 25, 33, 0.3) 40%,
				rgba(23, 25, 33, 0.8) 70%,
				#171921 100%
			);
		...
		.brand-card {
			...
			.info {
				...
				.label {
					font:
						500 #{$font-size-sm}/ 1.5 "Source Code Pro",
						monospace;
					color: #cd88ff;
