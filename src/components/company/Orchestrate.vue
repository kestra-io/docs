	...
	<main class="orchestrate">
		<section class="hero">
			<div class="grid">
				<div class="media">
					<NuxtImg
						src="/landing/company/teams/team.png"
						alt="Team Image"
						class="image"
						width="686"
						height="456"
				...
				<NuxtImg
					src="/landing/company/teams/line.svg"
					alt="Connecting Line"
					class="line"
					width="224"
					height="268"
		...
		<section class="trust">
			<div class="divider">
				<NuxtImg
					src="/landing/company/teams/Logo_EE.png"
					alt="Kestra Logo"
					class="logo"
					width="119"
					height="109"
				/>
				<NuxtImg
					src="/landing/company/teams/black-ellipse.svg"
					alt="Section Divider"
					width="228"
					height="135"
				/>
...
<script setup lang="ts">
	...
	const companyLogos = [
		{
			alt: "Apple",
			src: "/landing/company/teams/apple.svg",
			width: 38,
			height: 45,
		},
		...
		{
			alt: "Battelle",
			src: "/landing/company/teams/Battelle.svg",
			width: 101,
			height: 17,
		},
		{
			alt: "L'Oreal",
			src: "/landing/company/teams/loreal.svg",
			width: 115,
			height: 20,
		},
	]
