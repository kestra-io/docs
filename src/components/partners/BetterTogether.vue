<template>
    <div class="container">
        ...
        >
            <div class="row">
                <div v-for="testimonial in testimonialData" :key="testimonial.name" class="col-12 col-md-4 col-lg-4 mb-4 testimonials-item">
                    <TestimonialsItem v-bind="testimonial" />
                </div>
            </div>
        </Section>
    </div>
