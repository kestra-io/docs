<template>
    <section class="faq-section">
        <NuxtImg src="/landing/onezero/ring.webp" alt="Ring" class="background-ring" loading="lazy" />
        <div class="container">
...
const topFeatures = [
    ...
    },
    {
        ...
        description: "YAML, SDKs (Python, js/TS, Java, Go), or no code UI - all unrestricted and CICD-ready."
    },
    {
        icon: Security,
    ...
    },
    {
        ...
        description: "Horizontal workers, hot reload, safe rollouts, built-in plugin ecosystem."
    },
    {
...
.faq-section {
    ...
    .container {
        ...
        .session-card {
            ...
            text-align: center;
            width: 100%;
            box-shadow: 0 0px 32px rgba(0, 0, 0, 0.37),
