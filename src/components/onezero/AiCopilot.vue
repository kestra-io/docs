<template>
    <section class="wrapper">
        <div class="ai-copilot container">
            ...
            <div v-for="block in AI_BLOCKS_1" :key="block.title" class="ai-block">
                <h3>{{ block.title }}</h3>
            ...
            <div v-for="block in AI_BLOCKS_2" :key="block.title" class="ai-block">
                <h3>{{ block.title }}</h3>
                <p>{{ block.description }}</p>
                <NuxtImg
                    class="illu"
        ...
        <div class="velocity container">
            ...
            <div class="feature-list">
                <div v-for="feature in VELOCITY_FEATURES" :key="feature.title" class="feature-item">
    ...
    .first-line {
        ...
        .copilot-overview-illustration {
            ...
            .illu-code-background {
                ...
                -webkit-mask:
                    linear-gradient(var(--ks-background-body) 0 0) padding-box,
