                    ...
                    <Carousel v-bind="settings" :breakpoints="breakpoints">
                        <Slide v-for="(slide, slideIndex) in testimonialData" :key="slideIndex">
                            <div class="carousel--item">
                                <div class="content">
                                    <img class="slide-svg" src="/landing/pricing/slider-icon.svg" alt="Carousel img" />
                                    <span>{{ slide.message }}</span>
                                    <div class="person">
                                        <div class="fila-svg">
                                            <img src="/landing/pricing/fila.svg" alt="fila" />
                                        </div>
                                                ...
                                                <navigation>
                                                    <template #prev>
                                                        <div
                                                            ...
                                                            <img src="/landing/pricing/slider-left-arrow.svg"
                                                                alt="prev" />
                                                        </div>
                                                    </template>
                                                    <template #next>
                                                        <div
                                                            ...
                                                            <img src="/landing/pricing/slider-right-arrow.svg"
                                                                alt="next" />
                                                        </div>
                                                    </template>
                                                </navigation>
                                            </div>
                                            <div class="dot" v-for="(slide, index) in testimonialData"
                            ...
                            <navigation>
                                <template #next>
                                    <div class="carousel-btn carousel-control carousel-control-next">
                                        <img src="/landing/pricing/slider-right-arrow.svg" alt="next" />
                                    </div>
                                </template>
                                <template #prev>
                                    <div class="carousel-btn carousel-control carousel-control-prev ">
                                        <img src="/landing/pricing/slider-left-arrow.svg" alt="prev" />
                                    </div>
                                </template>
                            </navigation>
                        </template>
