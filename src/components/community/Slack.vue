<template>
	<div v-if="widget" class="widget-chat">
		<a v-if="mounted" href="https://kestra.io/slack" target="_blank" class="btn btn-sm btn-primary rounded">
			<Slack title="" />
			Slack
	...
	<div v-else class="container">
		<Section subtitle="Orchestrate Success" subtitle-after="Together"
			...
			<div class="text-center">
				<a v-if="mounted" href="https://kestra.io/slack" class="btn btn-animated btn-purple-animated me-2"
					target="_blank" data-usal="zoomin">
					Join our Slack
				</a>
			</div>
		</Section>
