<template>
    ...
    >
        ...
        <g filter="url(#filter0_d_116_24)">
            <path
                d="M50 111C52.7614 111 55 108.761 55 106C55 103.239 52.7614 101 50 101C47.2386 101 45 103.239 45 106C45 108.761 47.2386 111 50 111Z"
                fill="currentColor"
        ...
        <g filter="url(#filter1_d_116_24)">
            <circle cx="50" cy="301" r="5" fill="currentColor" class="connection-circle" />
        </g>
        ...
        <g filter="url(#filter2_d_116_24)">
            <circle cx="50" cy="496" r="5" fill="currentColor" class="connection-circle" />
        </g>
        ...
        <g filter="url(#filter3_d_116_24)">
            <circle cx="50" cy="722" r="5" fill="currentColor" class="connection-circle" />
        </g>
        <defs>
            <filter
                id="filter0_d_116_24"
            ...
            >
                ...
                <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.209505 0 0 0 0 0.331673 0 0 0 0 1 0 0 0 0.7 0"
                />
                <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_116_24"
                />
                <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_116_24"
                    result="shape"
                />
            </filter>
            <filter
