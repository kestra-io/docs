...
import { isEntryAPluginElementPredicate, subGroupName, buildPluginMappings, filterPluginsWithoutDeprecated, type Plugin, type PluginElement } from "@kestra-io/ui-libs";
...
export const GET: APIRoute = async () => {
    ...
    const allPages = filterPluginsWithoutDeprecated(allPlugins)
        .flatMap((plugin) => {
