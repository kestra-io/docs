                ...
                mainContent: [
                    {
                        ...
                        content: 'Streamlined Data Detection and Distribution: Kestra actively listens for changes in your chosen databases, such as PostgreSQL, detecting new entries and updates as they occur. Once identified, these changes are packaged and distributed to messaging systems like Apache Kafka, guaranteeing that downstream processes, including analytics processing performed by tools like Apache Spark, have access to the latest data without delay.<br /><br />' +
                    ...
                    },
                    {
                        ...
                        img: '/landing/usecases/cdc/feature-2.svg',
                        imgAlt: 'Picture of tasks possible with Kestra Change Data capture like data transformation, filtering, and aggregation',
