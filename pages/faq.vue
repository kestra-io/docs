        ...
        <div class="container">
            ...
            <CustomDetails title="What is Kestra?">
                <p>Kestra is an open-source orchestrator designed to bring Infrastructure as Code (IaC) best practices
                    to all workflows — from those orchestrating mission-critical operations, business processes, and
                    data pipelines to simple Zapier-style automation. Built with an API-first philosophy, Kestra enables
                    users to define and manage data pipelines through a simple YAML configuration file. This approach
            ...
            <CustomDetails title="What are the advantages of a declarative orchestrator?">
                ...
                <ol>
                    <li>Improved readability and maintainability: Declarative workflows are easier to understand and
                        modify, making it simpler for teams to collaborate and maintain their data pipelines over time.
                    </li>
                    <li>Enhanced flexibility: Declarative orchestration enables easy modification and extension of
            ...
            <CustomDetails title="Who can benefit from using Kestra?">
                <p>Kestra is perfect for data engineers, developers, data scientists, and anyone who needs to process,
                    manage, and orchestrate workflows across multiple systems.</p>
            </CustomDetails>
            ...
            <CustomDetails title="Can I create custom plugins for Kestra?">
                <p>Yes, Kestra allows developers to create custom plugins to add new tasks and integrations that suit
            ...
            <CustomDetails title="What languages are supported in Kestra flows?">
                ...
                <p>Furthermore, Kestra supports Docker, which enables you to execute tasks using any language, expanding
                    ...
                    different programming languages within your Kestra flows to suit your specific requirements.</p>
            </CustomDetails>
            ...
            <CustomDetails title="How do I get started with Kestra?">
                <p>To get started with Kestra, follow the
                    <NuxtLink href="/docs/quickstart#start-kestra">Getting Started Guide</NuxtLink>
            ...
            <CustomDetails title="How to install Kestra?">
                <p>Kestra is designed to be easy to install and set up. The installation process involves following the
                    <NuxtLink href="/docs/quickstart#start-kestra">official documentation</NuxtLink>
                    ...
                    including Docker, Kubernetes, and Helm. We are also available on our <a target="_blank"
                                                                                            href="/slack">Slack
                        channel</a> to provide assistance and answer any questions you might have during the
                    installation process.
                </p>
            </CustomDetails>
            <CustomDetails title="Is there a community or support forum for Kestra?">
                <p>Yes, Kestra has a growing community. You can join the <a target="_blank"
                                                                            href="https://kestra.io/slack">Kestra Slack
                    channel</a> to ask questions, share your experience, and connect with other users and developers.
                </p>
            </CustomDetails>

            <h2 data-aos="zoom-in" class="mt-5">Pricing and Licensing</h2>
            <CustomDetails title="Is Kestra open-source?">
                <p>Yes, Kestra is an open-source project. The source code is available on <a
                    href="https://github.com/kestra-io/kestra" target="_blank">GitHub</a> under the Apache 2.0 license.
                </p>
            </CustomDetails>
            <CustomDetails title="Are there any costs associated with using Kestra?">
                <p>Kestra is free to use as an open-source project. However, there might be additional costs related to
                    hosting, infrastructure, and any third-party services you choose to integrate with Kestra.</p>
            </CustomDetails>
            ...
            <CustomDetails title="What additional features does the Kestra Enterprise Edition offer?">
                <p>The Kestra Enterprise Edition provides enhanced features designed to meet the needs of large-scale
                    and
            ...
            <CustomDetails title="How does Kestra compare to other data orchestration platforms?">
                <p>Kestra stands out from other data orchestration platforms due to its focus on ease of use thanks to
                    declarative language YAML, powerful features, and a growing ecosystem of plugins. The user-friendly
                    interface and robust architecture make it an excellent choice for orchestrating complex data
                    workflows across various systems and services.</p>
                <ul>
                    <li> See how Kestra compare with <a target="_blank" href="/vs/airflow">Airflow</a></li>
                    <li> See how Kestra compare with <a target="_blank" href="/vs/prefect">Prefect</a></li>
                </ul>
            </CustomDetails>
            <CustomDetails title="Are there any limitations when using declarative flows in YAML?">
                <p>YAML's simplicity and readability make it easy to understand and maintain your data workflows. Kestra
                    provides extensive support for various YAML features, such as variables, loops, and conditions,
                    allowing you to create complex workflows without the need for a separate programming language. If
                    you require more advanced functionality, you can always use scripting languages like Python,
