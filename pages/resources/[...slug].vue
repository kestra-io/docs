        ...
        <div class="container bd-gutter bd-layout margin">
            <article class="bd-main order-1" v-if="page" :class="{'full': page.rightBar === false}">
                <ContentRenderer :value="page">
                    <div class="bd-content">
                        <div class="bd-title">
                            <p class="d-flex breadcrumb" data-aos="fade-right">
                                <NuxtLink to="/">Home </NuxtLink> / <NuxtLink to="/resources"> Resources </NuxtLink>
                            </p>
                    ...
                    <NavToc class="d-lg-block d-none right-menu" :page="page" :isShowSocialsList="false">
                        <template #footer>
