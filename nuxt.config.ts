...
export default defineNuxtConfig({
    ...
    routeRules: {
        ...
        '/docs/api-guide': {redirect: '/docs/open-source-api'},
        '/docs/api-reference/open-source': {redirect: '/docs/open-source-api'},
        '/docs/api-reference/enterprise': {redirect: '/docs/enterprise-api'},
