...
export default defineNuxtConfig({
    ...
    routeRules: {
        ...
        '/docs/enterprise/worker-isolation': {redirect: '/docs/enterprise/governance/allowed-plugins'},
        '/docs/enterprise/scalability/worker-isolation': {redirect: '/docs/enterprise/governance/allowed-plugins'},
