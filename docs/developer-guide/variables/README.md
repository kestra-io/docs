...
Variables are specific fields for task. They use the power of [Pebble](https://pebbletemplates.io/) with Kestra's special context system, allowing powerfull task composition.
