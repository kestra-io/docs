<template>
    <div class="container">
        ...
        >
            <div class="container usecase-intro text-center">
            ...
            <div class="row mb-5">
                <div class="col-md-6">
                    <img class="img-fluid" src="/landing/usecases/cdc-wip.png" alt="" />
                </div>
            ...
            <div class="row mb-5">
                <div class="col-md-6 p-5">
                    <h5>Workflow Configuration and Management with Kestra</h5>
                    <p>
