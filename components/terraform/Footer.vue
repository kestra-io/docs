...
<style scoped lang="scss">
    ...
    .container {
        ...
        background-image: linear-gradient($purple-31, $purple-31), radial-gradient(circle at top left, #B010FB 18.11%, #DE97FF 27.65%, #A227DB 36.31%, rgba(162, 39, 219, 0) 58.84%, rgba(166, 16, 236, 0.84) 80.5%);
