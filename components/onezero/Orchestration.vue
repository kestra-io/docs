            ...
            <div class="achievement" data-aos="fade-up" data-aos-delay="250">
                ...
                <div class="profile" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="profile-text">
                        ...
                        <p class="profile-title">CEO & Co-Founder</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    const features = [
        {
            ...
            description: "Describe the desired outcome and constraints; let agents handle the execution details.",
            image: "/landing/onezero/goals.png",
        },
        {
            title: "Autonomous by Design",
            description: "Agents can choose the next best action dynamically, while the declarative model ensures repeatable version-controlled code.",
            image: "/landing/onezero/autonomous.png",
        },
        {
            title: "Governed And Auditable",
            description: "Every decision is logged and observable, so you keep oversight without limiting your iteration speed.",
            image: "/landing/onezero/governed.png",
        }
    ]
</script>
