<template>
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            <li v-for="n in pages" :key="n" :role="n != '...' ? 'button' : ''" class="page-item"
                :class="{ 'active': (currentPage == n && n != '...'), 'disabled': n == '...' }"
                @click="changePage({ pageNo: n })"><span class="page-link text-dark fw-bold">{{ n }}</span></li>
