...
const workflowSteps = computed(() => [
    {
        ...
        description: 'Orchestrate all your processes with declarative YAML or directly from the UI. Design scalable workflows quickly, without boilerplate.',
    ...
    },
    {
        ...
        description: 'Schedule executions, react to real-time events, or call workflows through API and webhooks. Native event-driven orchestration.',
    ...
    },
    {
        ...
        description: 'Parallelize tasks, manage dependencies, handle retries. Kestra runs every step with precision and resilience.',
    ...
    },
    {
        ...
        description: 'Full observability over every execution. Access logs, outputs, and metrics in real time to debug faster and improve performance.',
...
const isSectionCentered = computed(() => {
    ...
    const isWellPositioned = top.value < viewportHeight * 0.5 && bottom.value > viewportHeight * 0.2
    ...
    .workflow-step {
        ...
        .gradient-border {
            ...
            @each $step, $color in $step-colors {
                &.#{$step}-border {
                    border-image: linear-gradient(180deg, #16181F 0%, #{$color} 37.02%, #{$color} 65.87%, #16181F 100%) 1;
                }
            }
