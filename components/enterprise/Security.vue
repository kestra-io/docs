    ...
    <div class="container">
        ...
        >   
                ...
                <div class="col-md-6 order-1 order-md-0" data-aos="fade-right">
                    ...
                    <ul>
                        <li><b>Worker groups:</b> Worker Groups allow targeted task execution and polling trigger evaluation on specialized compute instances, offering flexibility in system resources, operating system, backend access, and regional proximity.</li>
                        <li><b>High scalability and availability:</b> Ensure scalability and high availability with managed <b>Kafka</b> and <b>Elasticsearch</b> integrated into the Enterprise Edition to eliminate single point of failure.</li>
            ...
            <div class="row mb-5">
                ...
                <div class="col-md-6">
                    <h3>Advanced Workflow Collaboration</h3>
                    <p>
