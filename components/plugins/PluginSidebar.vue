<template>
    <nav v-if="pluginWrapper || pluginsWithoutDeprecated.length > 0" class="plugin-sidebar">
        ...
        <div class="sidebar-content">
            ...
            <div v-if="hasSubGroups" class="subgroups-list">
                <details
            ...
            <PluginElements
                v-else-if="pluginWrapper && hasDirectElements"
                class="direct-elements-list"
