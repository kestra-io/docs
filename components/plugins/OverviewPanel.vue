<template>
    <div>
        ...
        <div v-if="releaseVersions.length > 0" class="d-none d-lg-block pt-2 versions">
            ...
            >
                <summary class="older-summary">
                    Previous Versions
                    <component :is="showOlderVersions ? ChevronDown : ChevronRight" class="chevron" />
                </summary>
        ...
        <div v-if="repoUrl && !repoUrl.includes('plugin-ee')" class="d-none d-lg-block links-section">
            <strong class="h6">Links & Resources</strong>
            <div class="links">
                <a v-if="repoUrl" class="resource-btn github" :href="repoUrl" target="_blank" rel="noopener noreferrer" aria-label="Plugin GitHub repository">
                    <Github class="me-2" />
                    <span>Github</span>
                </a>
    ...
    .versions {
        ...
        .latest-ver {
            ...
            .latest-badge {
                ...
                box-shadow: 0 4px 4px rgba($green, .2);
        ...
        .old-versions {
            ...
            .older-summary {
                align-items: center;
                background-color: rgba($black-2, .44);
                border-bottom: 1px solid $black-3;
