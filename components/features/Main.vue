        ...
        <Section>
          <div class="heading mx-auto pb-4">
            <h2 class="title text-center">
              ...
              <span class="title-animate">No Ops Required.</span>
            </h2>
          </div>
          <div class="row mb-5">
            <div class="col-md-6" data-aos="fade-right">
              <img
                class="img-fluid img-declarative"
                src="/landing/features/declarative1.svg"
                alt="A YAML sample of code for declarative language and construction of Kestra's flows"
              />
            </div>
            <div
              class="col-md-6 p-5 text-white mt-5"
              data-aos="fade-right all-cards"
            >
          ...
          <div class="row mb-5">
            <div
              class="col-md-6 p-5 order-1 order-md-0 text-white mt-5"
              data-aos="fade-left"
            >
              <h3 class="card-heading">
            ...
            <div class="col-md-6 order-0 order-md-1" data-aos="fade-left">
              <img
                class="img-fluid"
                src="/landing/features/execute.svg"
          ...
          <div class="row mb-5">
            <div class="col-md-6" data-aos="fade-right">
              <img
                class="img-fluid img-flowable"
                src="/landing/features/flowable.svg"
                alt="A list of flowable tasks such as sequential, parallel, loop, switch, pause and template"
              />
            </div>
            <div class="col-md-6 p-5 text-white mt-5" data-aos="fade-right">
              <h3 class="card-heading">
          ...
          <div class="row mb-5">
            ...
            <div class="col-md-6 order-0 order-md-1 mb-5" data-aos="fade-left">
              <img
                class="img-fluid img-monitor"
                src="/landing/features/monitor.svg"
                alt="Stylized view of a monitoring dashboard"
              />
            </div>
          </div>
        </Section>
