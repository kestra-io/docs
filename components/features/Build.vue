                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">CI/CD Deployment</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Production made easy, no more production plan</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Event-Based</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Infinity of triggers</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Large Data Processing</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Micro-Batch for Real-Time</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">No single point of failure</h5>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card shadow-lg">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Performance Gains</h5>
