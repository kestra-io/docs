<template>
    <div class="main">
        <div class="container">
            <Section subtitle="Security and high availability" title="Take Kestra to the next level with the Enterprise Edition 🚀">
                <div class="row mb-5">
                    <div class="col-md-6">
                ...
                <div class="text-center">
                    <NuxtLink class="btn btn-lg btn-primary me-2" href="/enterprise-edition">Learn more</NuxtLink>
                    <NuxtLink class="btn btn-lg btn-dark " href="/company/contact">Contact us</NuxtLink>
                </div>
            </Section>
        </div>
    </div>
