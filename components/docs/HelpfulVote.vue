<template>
    <div class="helpful text-center mt-5">
        ...
        <div ref="modalRef" class="modal fade" id="feedbackModal" tabindex="-1" aria-labelledby="feedbackModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else class="submitted-state text-center py-4">
                            <h5 class="mb-2">Thanks for your feedback, we really appreciate it. 🙏</h5>
                        </div>
                    </div>
                    <div class="modal-footer" v-if="!isSubmitted">
                        <button type="button" class="btn btn-sm btn-secondary" @click="closeModal">Cancel</button>
                        <button type="button" class="btn btn-sm btn-primary" @click="submitFeedback">Submit</button>
                    </div>
                </div>
            </div>
        </div>
