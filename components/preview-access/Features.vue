        ...
        <div class="col-md-12 col-lg-7">
          ...
          <div class="row mt-4">
            ...
            <div class="col-6 mt-3">
              ...
              <p>
                Familiarize yourself with Kestra’s UI, workflow structure, and capabilities at your own pace.
              </p>
            </div>
            <div class="col-6 mt-3">
              <h6>
              ...
              <p>
                Apply for our Kestra Cloud Early Adopter Program: <href src="/cloud/">Apply</href>
              </p>
            </div>
          </div>
        </div>
    ...
    & .form {
      ...
      &::after {
        @media (min-width: 992px) {
          ...
          width: 200px;
          height: 200px;
          background-image: url("./images/logo_kestra.svg?url");
