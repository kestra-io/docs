...
.column-container {
  ...
  .left-column {
    ...
    .radio {
      ...
      &-option {
        ...
        input[type="radio"] {
          ...
          &:focus {
            outline: 0;
            box-shadow: 0 0 0 2px rgba($purple-40, .25);
          }
        }
    ...
    .success {
      ...
      font-weight: 600;
      animation:
        successAppear .6s cubic-bezier(.175, .885, .32, 1.275) forwards,
  ...
  .right-column {
    ...
    background-image: linear-gradient(to bottom, #151515 0%, rgba(21, 21, 21, 0) 50%),
