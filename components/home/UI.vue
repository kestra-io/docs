    ...
    <div class="bg-dark-4">
        <div class="container">
            ...
            >
                <div class="row mb-5">
                    <div class="col-lg-8">
                        <NuxtImg format="webp" loading="lazy" v-if="active === 1" src="/landing/home/ui-1.svg" alt="Picture of Kestra's user interface" class="w-100 zoom img-fluid rounded-3" data-aos="fade-right" />
                        <NuxtImg format="webp" loading="lazy" v-if="active === 2" src="/landing/home/ui-2.svg" alt="Picture of Kestra's user interface" class="w-100 zoom img-fluid rounded-3" data-aos="fade-right" />
                        <NuxtImg format="webp" loading="lazy" v-if="active === 3" src="/landing/home/ui-3.svg" alt="Picture of Kestra's user interface" class="w-100 zoom img-fluid rounded-3" data-aos="fade-right" />
                        <NuxtImg format="webp" loading="lazy" v-if="active === 4" src="/landing/home/ui-4.svg" alt="Picture of Kestra's user interface" class="w-100 zoom img-fluid rounded-3" data-aos="fade-right" />
                    </div>
