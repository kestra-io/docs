                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#">Visit the Airbyte website <OpenInNew /></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#">Visit the dlthub website <OpenInNew /></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <div class="coming-soon d-inline rounded text-white">Coming soon...</div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary">Become a Technology Partner</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-4 col-lg-4 mb-4">
                    <div class="card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#">Visit the Converteo website <OpenInNew /></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 mb-4">
