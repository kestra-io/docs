        ...
        <div class="hero container">
            <div class="row">
                <div class="col-md-6 align-items-center d-flex">
                    <div>
                        <h1 data-aos="fade-right">The differences between Kestra and Google Workflows</h1>
                ...
                <div class="col-md-6 d-flex justify-content-center" data-aos="zoom-in">
                    <img class="zoom img-fluid" src="/landing/vs/google-workflows/header.svg" alt="Kestra compared to Google Workflows"/>
                </div>
            </div>
        </div>
    </div>
