        ...
        <foreignObject x="0" y="0" width="1200" height="625">
            <div xmlns="http://www.w3.org/1999/xhtml" style="width: 1200px; height: 625px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-image: url('${baseUrl}/og-bg.svg'); background-size: cover; background-position: center; color: #ffffff; padding: 20px;">
                ...
                <div style="position: absolute; top: 187.88px; left: 55.64px;">
                  <p style="font-family: 'Public Sans', sans-serif; font-size: 31.69px; font-weight: 600; line-height: 52.76px; color: #CD88FF; margin: 0;">PLUGINS</p>
                  <h1 style="width: 562.89px; font-family:  'Public Sans', sans-serif; font-size: 75px; font-weight: 600; line-height: 74px; color: #FFFFFF; margin-top: 47.86px">${plugin?.body?.title || name}</h1>
                  <p  style="width: 562.89px; font-family:  'Public Sans', sans-serif; font-size: 29px; font-weight: 600; line-height: 44px; color: #FFFFFF; margin-top: 38.68px">${plugin?.body?.description || title || ''}</p>
                </div>
            </div>
        </foreignObject>
    </svg>`;
