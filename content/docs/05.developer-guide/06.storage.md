...
- The [Shell](../../plugins/plugin-scripts-shell/tasks/io.kestra.plugin.scripts.shell.Script.md) task will execute a single command, or a list of commands that you provide.
