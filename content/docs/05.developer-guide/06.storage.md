...
You can make basic data processing thanks to variables processing offered by the Pebble templating engine, see [variables basic usage](./../03.concepts/expression/01.index.md).
...
2. The [Blueprints](../00.getting-started/07.ui.md#blueprints) catalog — simply search for the relevant language (e.g. Python, R, Rust)  or use case (*ETL, Git, dbt, etc.*) to find the relevant examples.
