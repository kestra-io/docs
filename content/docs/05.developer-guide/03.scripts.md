...
The previous sections in the Developer Guide covered [Flows](01.flow.md) and [Tasks](03.concepts/tasks.md). This section covers script tasks.
...
Head over to the [Secrets](secret.md) section to learn more about secrets management in Kestra.
...
Check the [Outputs](outputs.md) page for more details about managing outputs.
