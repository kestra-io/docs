...
**Full class names:**
- [io.kestra.plugin.scripts.python.Commands](../../plugins/plugin-scripts-python/tasks/io.kestra.plugin.scripts.python.Commands.md)
- [io.kestra.plugin.scripts.python.Script](../../plugins/plugin-scripts-python/tasks/io.kestra.plugin.scripts.python.Script.md)
- [io.kestra.plugin.scripts.r.Commands](../../plugins/plugin-scripts-r/tasks/io.kestra.plugin.scripts.r.Commands.md)
- [io.kestra.plugin.scripts.r.Script](../../plugins/plugin-scripts-r/tasks/io.kestra.plugin.scripts.r.Script.md)
- [io.kestra.plugin.scripts.node.Commands](../../plugins/plugin-scripts-node/tasks/io.kestra.plugin.scripts.node.Commands.md)
- [io.kestra.plugin.scripts.node.Script](../../plugins/plugin-scripts-node/tasks/io.kestra.plugin.scripts.node.Script.md)
- [io.kestra.plugin.scripts.shell.Commands](../../plugins/plugin-scripts-shell/tasks/io.kestra.plugin.scripts.shell.Commands.md)
- [io.kestra.plugin.scripts.shell.Script](../../plugins/plugin-scripts-shell/tasks/io.kestra.plugin.scripts.shell.Script.md)
- [io.kestra.plugin.scripts.powershell.Commands](../../plugins/plugin-scripts-powershell/tasks/io.kestra.plugin.scripts.powershell.Commands.md)
- [io.kestra.plugin.scripts.powershell.Script](../../plugins/plugin-scripts-powershell/tasks/io.kestra.plugin.scripts.powershell.Script.md)
...
If you want to generate files in your script to make them available for download and use in downstream tasks, you can leverage the `outputDir`. Files stored in that directory will be persisted in Kestra's internal storage. Here is an example: 
