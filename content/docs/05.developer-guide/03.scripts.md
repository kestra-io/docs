...
Also, note that `PROCESS` can be used with Kestra running in a Docker container. You can add your custom binaries into the Dockerfile, as [explained in this part](../09.administrator-guide/02.deployment/01.docker.md).
