...
Also note that `PROCESS` can be used with Kestra running on Docker. You might need to bring your own binary into the Dockerfile, as [explained in this part](../09.administrator-guide/02.deployment/01.docker.md).
