...
::alert{type="info"}
When creating a service account role for the GitHub Action in the [Enterprise Edition](https://kestra.io/enterprise), you need to grant the `FLOWS` permission to the Role.
::
