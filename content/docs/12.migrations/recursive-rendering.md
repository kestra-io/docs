...
Check the [`render()` function's documentation](../07.concepts/06.expressions/04.function/render.md) for more details about how to use that function and when to use it.
