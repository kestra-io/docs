...
::alert{type="info"}
To install Kestra, check the [Getting Started](../00.getting-started/index.md) page.
::
...
You can optionally add a [description](../03.concepts/descriptions.md) property to keep your flows documented. The `description` is a string that supports **markdown** syntax. That markdown description will be rendered and displayed in the UI.
