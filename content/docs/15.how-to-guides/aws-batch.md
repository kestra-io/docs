...
1. An AWS account.
2. A running Kestra instance in a version 0.16.0 or later with AWS credentials stored as [secrets](https://kestra.io/docs/concepts/secret) or environment variables within the Kestra instance.
...
4. In the **Select trusted entity**, choose **Custom trust policy** and paste the following `Trust policy JSON:
    ...
    ```
   ![iam](/docs/how-to-guides/taskrunner-aws-batch/batch1.png)
5. Click on **Next** twice. Then, for **Role Name**, enter `ecsTaskExecutionRole`
6. Finally, click on **Create role**.

![create_role](/docs/how-to-guides/taskrunner-aws-batch/batch2.png)
...
![img.png](/docs/how-to-guides/taskrunner-aws-batch/batch4_search.png)

Then, click on "Get Started". If you don't see the "Get Started" button, add `#firstRun` to the URL:

![img.png](/docs/how-to-guides/taskrunner-aws-batch/batch4_firstrun.png)

This will launch a Wizard that will guide you through the process of creating a new compute environment.

![img.png](/docs/how-to-guides/taskrunner-aws-batch/batch4_jobtype.png)
...
![img_8.png](/docs/how-to-guides/taskrunner-aws-batch/batch9.png)
...
![img_10.png](/docs/how-to-guides/taskrunner-aws-batch/batch11.png)

![img_11.png](/docs/how-to-guides/taskrunner-aws-batch/batch12.png)
