...
You can use webhooks to trigger an execution of your flow in Kestra. To do this, we can make a [trigger](../04.workflow-components/07.triggers.md#webhook-trigger) with the type `io.kestra.core.models.triggers.types.Webhook`.
