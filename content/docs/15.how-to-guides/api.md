...
With the Enterprise Edition, you can generate [API Tokens](../06.enterprise/03.auth-rbac-user-management/api-tokens.md) to authenticate when making requests, for example:
