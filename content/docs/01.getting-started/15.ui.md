...
Explore Kestra's beautiful User Interface and the embedded Code Editor.
...
- The **Editor** page provides an embedded Code editor to create and edit flows and custom scripts.
...
On the **Editor** page, you will see the embedded Code editor. To use it, you will need to select the namespace in which you want to develop flows and namespace files.
