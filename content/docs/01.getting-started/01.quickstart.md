...
Once starting Kestra and opening the port in the browser, Kestra will prompt you to create your user. If you have not set credentials in the configuration, you create them at this stage. If already set in the configuration, refer to your configuration file and check the following section of the YAML:
