...
- During startup if **JavaScript memory heap out**, configure following environment variable with some larger value
    ...
    - Example   `NODE_OPTIONS : --max-old-space-size=4096` or `NODE_OPTIONS : --max-old-space-size=8192` ![Intellij IDEA Configuration ](/public/docs/contribution/standalone.png)  
