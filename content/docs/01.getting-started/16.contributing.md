...
You can contribute to Kestra in many ways depending on your skills and interests. The issues with a label `kind/good-first-issue` are a great place to start and get familiar with the codebase. Follow this link to see the [good first issues](https://github.com/search?q=org:kestra-io+label:kind/good-first-issue+is:open&type=issues).
