...
3. **Dynamic Scaling** – [Task runners](../06.enterprise/04.scalability-productivity/task-runners.md) provision resources on-demand (AWS ECS Fargate, Google Batch) for heavy workloads.
