...
Kestra uses [internal storage](../07.architecture/09.internal-storage.md) to store data processed by tasks. This includes files from flow inputs and data stored as task outputs.
