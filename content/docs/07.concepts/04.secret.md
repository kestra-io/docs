...
You can leverage the `secret()` function, described in the [function section](../expressions/04.function/secret.md), to retrieve sensitive variables within your flow code.
