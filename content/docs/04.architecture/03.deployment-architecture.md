...
Kafka configuration options are available [here](../10.configuration-guide/03.enterprise-edition/kafka.md).
...
Elasticsearch configuration options are available [here](../10.configuration-guide/03.enterprise-edition/elasticsearch.md).
