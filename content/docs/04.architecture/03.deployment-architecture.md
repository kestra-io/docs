...
Kafka configuration options are available [here](../10.configuration-guide/kafka.md).
...
Elasticsearch configuration options are available [here](../10.configuration-guide/elasticsearch.md).
