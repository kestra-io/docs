...
export const pluginsFetched = await fetch('https://api.kestra.io/v1/plugins/subgroups').then(async (r) => r.json());
...
Thanks to <PluginCount subgroups={pluginsFetched} /> plugins and embedded Code editor with Git and Terraform integrations, Kestra makes scheduled and event-driven workflows easy.
