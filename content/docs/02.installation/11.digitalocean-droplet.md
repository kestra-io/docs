...
5. A new access key with the given name will be generated. Take a note of the secret key as you would not be able to retriev it later.
...
Let us now proceed to create a bucket in the Spaces Object Storage.
