...
![ec2 creation](../../../public/docs/administrator-guide/deployment/aws-ec2/ec2_setup1.png)

![ec2 key pair](../../../public/docs/administrator-guide/deployment/aws-ec2/ec2_setup2.png)

![ec2 network subgroup](../../../public/docs/administrator-guide/deployment/aws-ec2/ec2_setup3.png)
...
Use editor such as Vim to modify the `docker-compose.yml` and set basic authentication to true, and configure your basic authentication credentials to secure your Kestra instance.<br>
<b>Note:</b> You will need to provide a valid email address for the username
...
![ec2 inbound rules](../../../public/docs/administrator-guide/deployment/aws-ec2/ec2_security_group_port_inbound_rules.png)
...
![rds setup](../../../public/docs/administrator-guide/deployment/aws-ec2/rds_setup1.png)

![rds password](../../../public/docs/administrator-guide/deployment/aws-ec2/rds_setup2.png)

![rds connectivity](../../../public/docs/administrator-guide/deployment/aws-ec2/rds_setup3.png)
...
![S3 iam](../../../public/docs/administrator-guide/deployment/aws-ec2/IAM-usergroup.png)
