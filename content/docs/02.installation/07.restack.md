...
![restack-signup](../../administrator-guide/deployment/restack/restack-sign-up.png)
...
1. Navigate to the **Clusters** tab and click on **Create cluster**.
    ![create-cluster](../../administrator-guide/deployment/restack/restack-create-cluster.png)
...
![creating-cluster](../../administrator-guide/deployment/restack/restack-creating-cluster.png)
![cluster-created](../../administrator-guide/deployment/restack/restack-cluster-created.png)
...
2. Click **Kestra**.
    ![select-lightdash](../../administrator-guide/deployment/restack/kestra-select.png)
...
![lightdash-deployed](../../administrator-guide/deployment/restack/kestra-deployed.png)
...
For more information about global environment variables, check the following [documentation page](../expressions/02.expression-types.md).
