...
![vm setup1](../../administrator-guide/deployment/azure-vm/vm_setup1.png)

![vm setup2](../../administrator-guide/deployment/azure-vm/vm_setup2.png)

![vm setup3](../../administrator-guide/deployment/azure-vm/vm_setup3.png)

Wait until the virtual machine is up and running.

![vm setup4](../../administrator-guide/deployment/azure-vm/vm_setup4.png)
...
![vm choose_networking](../../administrator-guide/deployment/azure-vm/vm_choose_networking.png)

![vm inbound_port](../../administrator-guide/deployment/azure-vm/vm_inbound_port.png)
...
![db_setup1](../../administrator-guide/deployment/azure-vm/db_setup1.png)

![db_setup2](../../administrator-guide/deployment/azure-vm/db_setup2.png)

![db_setup3](../../administrator-guide/deployment/azure-vm/db_setup3.png)
...
For more information on Azure Blob storage configuration, check out the guide [here](../10.configuration-guide/02.storage.md#azure).
