...
![vm creation_1](../../administrator-guide/deployment/gcp-vm/vm_setup1.png)

![vm creation 2](../../administrator-guide/deployment/gcp-vm/vm_setup2.png)

![change_boot_disk_image](../../administrator-guide/deployment/gcp-vm/vm_setup3.png)

![vm_creation_3](../../administrator-guide/deployment/gcp-vm/vm_setup4.png)
...
![ssh_into_vm](../../administrator-guide/deployment/gcp-vm/ssh_into_vm.png)
...
![vm_network_details_option](../../administrator-guide/deployment/gcp-vm/vm_network_details_option.png)

![vm_network_interface_details](../../administrator-guide/deployment/gcp-vm/vm_network_interface_details.png)

![vm_firewall_policies](../../administrator-guide/deployment/gcp-vm/vm_firewall_policies.png)

![vm_create_firewall_rule](../../administrator-guide/deployment/gcp-vm/vm_create_firewall_rule.png)
...
![db_choices](../../administrator-guide/deployment/gcp-vm/db_choices.png)

![db_setup](../../administrator-guide/deployment/gcp-vm/db_setup.png)

![db_show_config](../../administrator-guide/deployment/gcp-vm/db_show_config_options.png)
...
![db_connections](../../administrator-guide/deployment/gcp-vm/db_connections.png)

![db_enable_api](../../administrator-guide/deployment/gcp-vm/db_enable_api.png)

![db_auto_allocate](../../administrator-guide/deployment/gcp-vm/db_auto_allocate.png)

![db_auto_allocate](../../administrator-guide/deployment/gcp-vm/db_create_connection.png)
...
![db_deletion_protection](../../administrator-guide/deployment/gcp-vm/db_deletion_protection.png)
...
![db_users](../../administrator-guide/deployment/gcp-vm/db_users.png)

![db_user_creation](../../administrator-guide/deployment/gcp-vm/db_user_creation.png)
