...
![vm creation_1](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_setup1.png)

![vm creation 2](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_setup2.png)

![change_boot_disk_image](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_setup3.png)

![vm_creation_3](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_setup4.png)
...
![ssh_into_vm](../../../public/docs/administrator-guide/deployment/gcp-vm/ssh_into_vm.png)

Kestra can be started directly from a `.jar` binary or using Docker. We’ll use Docker here for a quicker setup.
Install Docker on the EC2 instance. [You can find the last updated instruction on the Docker website](https://docs.docker.com/engine/install/ubuntu/).
...
![vm_network_details_option](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_network_details_option.png)

![vm_network_interface_details](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_network_interface_details.png)

![vm_firewall_policies](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_firewall_policies.png)

![vm_create_firewall_rule](../../../public/docs/administrator-guide/deployment/gcp-vm/vm_create_firewall_rule.png)
...
![db_choices](../../../public/docs/administrator-guide/deployment/gcp-vm/db_choices.png)

![db_setup](../../../public/docs/administrator-guide/deployment/gcp-vm/db_setup.png)

![db_show_config](../../../public/docs/administrator-guide/deployment/gcp-vm/db_show_config_options.png)

**Enable VM connection to database**

1. Expand the `Connections` section from the drop downs.
...
![db_connections](../../../public/docs/administrator-guide/deployment/gcp-vm/db_connections.png)

![db_enable_api](../../../public/docs/administrator-guide/deployment/gcp-vm/db_enable_api.png)

![db_auto_allocate](../../../public/docs/administrator-guide/deployment/gcp-vm/db_auto_allocate.png)

![db_auto_allocate](../../../public/docs/administrator-guide/deployment/gcp-vm/db_create_connection.png)
...
![db_deletion_protection](../../../public/docs/administrator-guide/deployment/gcp-vm/db_deletion_protection.png)
...
![db_users](../../../public/docs/administrator-guide/deployment/gcp-vm/db_users.png)

![db_user_creation](../../../public/docs/administrator-guide/deployment/gcp-vm/db_user_creation.png)
