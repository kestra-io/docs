...
![vm creation_1](assets/docs/administrator-guide/deployment/gcp-vm/vm_setup1.png)

![vm creation 2](assets/docs/administrator-guide/deployment/gcp-vm/vm_setup2.png)

![change_boot_disk_image](assets/docs/administrator-guide/deployment/gcp-vm/vm_setup3.png)

![vm_creation_3](assets/docs/administrator-guide/deployment/gcp-vm/vm_setup4.png)
...
![ssh_into_vm](assets/docs/administrator-guide/deployment/gcp-vm/ssh_into_vm.png)
...
![vm_network_details_option](assets/docs/administrator-guide/deployment/gcp-vm/vm_network_details_option.png)

![vm_network_interface_details](assets/docs/administrator-guide/deployment/gcp-vm/vm_network_interface_details.png)

![vm_firewall_policies](assets/docs/administrator-guide/deployment/gcp-vm/vm_firewall_policies.png)

![vm_create_firewall_rule](assets/docs/administrator-guide/deployment/gcp-vm/vm_create_firewall_rule.png)
...
![db_show_config](assets/docs/administrator-guide/deployment/gcp-vm/db_show_config_options.png)
...
![db_connections](assets/docs/administrator-guide/deployment/gcp-vm/db_connections.png)

![db_enable_api](assets/docs/administrator-guide/deployment/gcp-vm/db_enable_api.png)

![db_auto_allocate](assets/docs/administrator-guide/deployment/gcp-vm/db_auto_allocate.png)

![db_auto_allocate](assets/docs/administrator-guide/deployment/gcp-vm/db_create_connection.png)
...
![db_deletion_protection](assets/docs/administrator-guide/deployment/gcp-vm/db_deletion_protection.png)
