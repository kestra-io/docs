...
By default, the base Docker image `kestra/kestra:latest` does not contain any plugins (unless you use the `kestra/kestra:latest` version). You can add specific plugins to the base image and build a custom image.
