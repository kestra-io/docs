...
The above configuration enables a standalone pod for each Kestra component (webserver, executor, indexer, etc.) and disables the combined, standalone pod. This offers more scalability because you can granularly manage the resource allocation of each component depending on workflows in your instance and how intensely each component is utilized.
