...
You can create a `values.yml` and add any of the values from the GitHub repository to it like below to update your configuration:
...
To make these changes, save the `values.yml` and upgrade your Helm Charts:
