...
::alert{type="info"}
In order to run Kestra using `docker-compose.yml` file in production in rootless mode, please look at the `Launch Kestra in Rootless Mode` section on the [Podman Compose](/docs/installation/podman-compose) page.
::
