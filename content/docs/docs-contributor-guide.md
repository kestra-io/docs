...
The `video-container` is maintained in the repository's `docs.scss` file. Check out the [Contributing Guide](01.getting-started/03.contributing.md) to see a page with a video embedded.
