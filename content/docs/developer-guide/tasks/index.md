...
|`description`|The description of the task, more details [here](../flow#document-your-flow).|
|`retry`|Task retry behavior, more details [here](../errors-handling#retries).|
...
Task properties can be static or dynamic. Dynamic task properties can be set using [variables](../variables). To know if a task property is dynamic, read the task's documentation.
