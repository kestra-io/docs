...
- doesn't contains some binaries for [Python tasks](/plugins/core/tasks/scripts/io.kestra.core.tasks.scripts.Python.html) or [Node tasks](/plugins/core/tasks/scripts/io.kestra.core.tasks.scripts.Node.html).

#### `kestra/kestra:latest-full`
This image contains all the kestra plugins and all the binaries for [Python tasks](/plugins/core/tasks/scripts/io.kestra.core.tasks.scripts.Python.html) or [Node tasks](/plugins/core/tasks/scripts/io.kestra.core.tasks.scripts.Node.html).
