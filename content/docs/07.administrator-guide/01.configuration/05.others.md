...
By default, [deprecated handlebars](../../04.developer-guide/03.variables/08.deprecated-handlebars/index.md) is disabled, it can be enabled by setting this option to `true`.
