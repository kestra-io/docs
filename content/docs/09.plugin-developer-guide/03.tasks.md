...
Here is a simple [Runnable Task](../07.concepts/02.runnable-tasks) that reverses a string:
...
[Flowable tasks](../07.concepts/01.flowable-tasks) are the most complex tasks to develop, and will usually be available from the Kestra core. You will rarely need to create a flowable task by yourself.
