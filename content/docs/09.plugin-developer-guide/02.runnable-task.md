...
String render = runContext.render(format);
```
In order to use [variables](../04.developer-guide/03.variables/01.index.md), you need to render the variables, aka: transform the properties with Pebble.
...
All outputs will be available for next tasks through [variables](../04.developer-guide/03.variables/01.index.md).
