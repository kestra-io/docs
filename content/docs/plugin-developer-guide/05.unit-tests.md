...
There are two main ways to unit-test your tasks. In any case, your test must be annotated with `@KestraTest` to properly starts the Kestra needed components.
