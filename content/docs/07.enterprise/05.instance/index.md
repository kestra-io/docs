...
![Instance System Overview](/docs/enterprise/instance-system-overview.png)
...
From the **Instance - Services** tab, enter [Maintenance Mode](../05.instance/maintenance-mode.md) to temporarily pause all workflows and services for upgrades:
