...
- The **Variables** tab allows setting [variables](../03.concepts/06.expressions/01.index.md#namespace-variables-ee) scoped to a namespace.
- The **Task defaults** tab allows setting task default scoped to a namespace.
- The **Secrets** tab allows setting secrets accessible via the [secret function](../03.concepts/06.expressions/04.function/secret.md).
