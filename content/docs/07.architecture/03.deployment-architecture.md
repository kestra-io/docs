...
In this deployment mode, unless all components run on the same host, you must use a distributed storage implementation like [Google Cloud Storage](../02.installation/03.docker-compose/02.gcp-vm.md), [AWS S3](../02.installation/03.docker-compose/01.aws-ec2.md), or [Azure Blob Storage](../02.installation/03.docker-compose/03.azure-vm.md).
