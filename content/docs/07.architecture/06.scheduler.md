...
The Scheduler is a server component responsible for processing all triggers except for the [Flow Triggers](../04.workflow-components/07.triggers/flow-trigger.md) (managed by the executor).
