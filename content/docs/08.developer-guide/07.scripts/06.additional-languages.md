...
Here is an example flow that runs a Rust file inside of a container using a `golang` image:
...
Check out the [full guide](../../15.how-to-guides/rust.md) which includes using [outputs and metrics](07.outputs-metrics.md).
