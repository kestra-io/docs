...
* **Local**: error handling local to a [Flowable Task](../07.concepts/flowable-tasks.md), will handle errors for the flowable task and its children.
...
Retries provide a way to automatically retry a task when it fails. Check the [Retries](../07.concepts/retries.md) documentation for more details.