...
The previous sections in the Developer Guide covered [Flows](../07.concepts/flow.md) and [Tasks](../07.concepts/tasks.md). This section covers script tasks.
...
Head over to the [Secrets](../07.concepts/secret.md) section to learn more about secrets management in Kestra.
