...
::collapse{title="Setup for Plugin Development"}
## Plugin Template
...
::collapse{title="Gradle configuration"}
...
::collapse{title="Develop a Trigger"}
...
::collapse{title="Develop a Condition"}
...
::collapse{title="Document your plugin"}
...
::collapse{title="Build and publish a plugin"}
