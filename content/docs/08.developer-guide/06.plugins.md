...
The template includes a [Dockerfile](https://github.com/kestra-io/plugin-template/blob/master/Dockerfile) that already copies the built artifact to docker's plugins directory. You can build and run the image with the following command assuming you're in the root directory of your plugin:
