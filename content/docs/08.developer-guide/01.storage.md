...
The same syntax applies to SQL queries, concustom scripts, and many more. Check the [Namespace Files](/docs/developer-guide/namespace-files) documentation for more details.
