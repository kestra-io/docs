...
- You can attach [namespace files](../../05.developer-guide/namespace-files.md) to the `WorkingDirectory` task and use them in all downstream tasks. This allows you to work the same way you would work on your local machine, where you can import modules from the same directory.
