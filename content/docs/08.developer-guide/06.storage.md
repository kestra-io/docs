...
1. The [Script documentation](./scripts/index.md) for a detailed overview of how to work with Python, R, Node.js, Shell and Powershell scripts and how to integrate them with Git and Docker.
