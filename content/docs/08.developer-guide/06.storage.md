...
If you need to access data from the internal storage, you can use the Pebble [read](../07.concepts/expression/04.function/read.md) function to read the file's content as a string.
