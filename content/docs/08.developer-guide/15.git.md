...
Kestra supports version control with Git. You can use one or more Git repositories to store your [Flows](../07.concepts/flow.md) and [Namespace Files](./namespace-files.md), and track changes to them over time via Git commit history.
...
This flow can also be triggered anytime you push changes to Git via a [GitHub webhook](../07.concepts/05.triggers/webhook-trigger.md):
