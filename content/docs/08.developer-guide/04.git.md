...
Kestra supports version control with Git. You can use one or more Git repositories to store your [Flows](../06.workflow-components/02.flow.md) and [Namespace Files](./03.namespace-files), and track changes to them over time via Git commit history.
