...
- `kestra.metrics.prefix`: Change the prefix for [all metrics](../03.monitoring/index.md#kestra-metrics) for Kestra (default: kestra).
...
HTTP Basic Authentication is disabled by default. If you are using Kestra Enterprise Edition, more authentication mechanisms are available; see [here](03.enterprise-edition/authentifications/index.md).
