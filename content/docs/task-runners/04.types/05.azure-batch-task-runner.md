...
![search](assets/docs/concepts/taskrunner-azure-batch/search.png)

Now on that page, select **Create** to make a new account.

![create-account](assets/docs/concepts/taskrunner-azure-batch/create-account.png)
...
![new-account](assets/docs/concepts/taskrunner-azure-batch/new-account.png)
...
![storage-account](assets/docs/concepts/taskrunner-azure-batch/storage-account.png)

![create-storage-account](assets/docs/concepts/taskrunner-azure-batch/create-storage-account.png)
...
![account-created](assets/docs/concepts/taskrunner-azure-batch/account-created.png)
...
![pools-menu](assets/docs/concepts/taskrunner-azure-batch/pools-menu.png)

On the **Add pool** page, enter a Pool ID.

![pool-name](assets/docs/concepts/taskrunner-azure-batch/pool-name.png)
...
![os](assets/docs/concepts/taskrunner-azure-batch/os.png)
...
![node-size](assets/docs/concepts/taskrunner-azure-batch/node-size.png)
...
![data-storage](assets/docs/concepts/taskrunner-azure-batch/data-storage.png)

Type in a name for the container and select **Create**.

![create-container](assets/docs/concepts/taskrunner-azure-batch/create-container.png)
...
![logs](assets/docs/concepts/taskrunner-azure-batch/logs.png)

We can also go to the Azure Portal to see our task runner has been created:

![batch-jobs](assets/docs/concepts/taskrunner-azure-batch/batch-jobs.png)
...
![outputs](assets/docs/concepts/taskrunner-azure-batch/outputs.png)
