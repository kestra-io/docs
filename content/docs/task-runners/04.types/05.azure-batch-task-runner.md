...
![search](../../../concepts/taskrunner-azure-batch/search.png)

Now on that page, select **Create** to make a new account.

![create-account](../../../concepts/taskrunner-azure-batch/create-account.png)
...
![new-account](../../../concepts/taskrunner-azure-batch/new-account.png)
...
![storage-account](../../../concepts/taskrunner-azure-batch/storage-account.png)

![create-storage-account](../../../concepts/taskrunner-azure-batch/create-storage-account.png)
...
![account-created](../../../concepts/taskrunner-azure-batch/account-created.png)
...
![pools-menu](../../../concepts/taskrunner-azure-batch/pools-menu.png)

On the **Add pool** page, enter a Pool ID.

![pool-name](../../../concepts/taskrunner-azure-batch/pool-name.png)
...
![os](../../../concepts/taskrunner-azure-batch/os.png)
...
![node-size](../../../concepts/taskrunner-azure-batch/node-size.png)
...
![data-storage](../../../concepts/taskrunner-azure-batch/data-storage.png)

Type in a name for the container and select **Create**.

![create-container](../../../concepts/taskrunner-azure-batch/create-container.png)
...
![logs](../../../concepts/taskrunner-azure-batch/logs.png)

We can also go to the Azure Portal to see our task runner has been created:

![batch-jobs](../../../concepts/taskrunner-azure-batch/batch-jobs.png)
...
![outputs](../../../concepts/taskrunner-azure-batch/outputs.png)
