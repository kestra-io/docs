...
4. In the **Select trusted entity**, choose **Custom trust policy** and paste the following `Trust policy JSON:
    ...
    ```
   ![iam](../../../concepts/taskrunner-aws-batch/iam.png)
...
![create_role](../../../concepts/taskrunner-aws-batch/create_role.png)

Make sure to copy the ARN of the role. You will need it later.

![role_arn](../../../concepts/taskrunner-aws-batch/role_arn.png)
...
6. Search for the new policy and check the box on the left. Once you've done this, select **Next**.
   ![role_permission](../../../concepts/taskrunner-aws-batch/role_permission.png)
...
![batch5](../../../concepts/taskrunner-aws-batch/batch5.png)
...
![batch6](../../../concepts/taskrunner-aws-batch/batch6.png)
...
![batch7](../../../concepts/taskrunner-aws-batch/batch7.png)

#### Step 5: Create a job

Finally, create a job. Here, we name it "kestra". Then, click on Next for a final review:

![batch8](../../../concepts/taskrunner-aws-batch/batch8.png)

#### Step 6: Review and create

Review your settings and click on Create resources:

![batch9](../../../concepts/taskrunner-aws-batch/batch9.png)

Once you see this message, you are all set:

![batch10](../../../concepts/taskrunner-aws-batch/batch10.png)
...
![batch11](../../../concepts/taskrunner-aws-batch/batch11.png)

![batch12](../../../concepts/taskrunner-aws-batch/batch12.png)

### Create an S3 Bucket

Last thing we'll need is an S3 storage bucket. To do this, select S3 from Services then select **Create bucket**.

![s3_create](../../../concepts/taskrunner-aws-batch/s3_create.png)

Next you'll need to add a name and leave everything else as a default value.

![s3_bucket_name](../../../concepts/taskrunner-aws-batch/s3_bucket_name.png)
...
![logs](../../../concepts/taskrunner-aws-batch/logs.png)
