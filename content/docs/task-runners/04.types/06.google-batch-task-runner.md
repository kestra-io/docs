...
![project](../../../concepts/taskrunner-gcp-batch/project.png)

Once you've done this, make sure your project is selected in the menu bar.

![project_selection](../../../concepts/taskrunner-gcp-batch/project-selection.png)
...
![batchapi](../../../concepts/taskrunner-gcp-batch/batchapi.png)
...
![api-credentials-1](../../../concepts/taskrunner-gcp-batch/api-credentials-1.png)
...
![sa-1](../../../concepts/taskrunner-gcp-batch/sa-1.png)
...
![roles](../../../concepts/taskrunner-gcp-batch/roles.png)
...
![create-key](../../../concepts/taskrunner-gcp-batch/create-key.png)
...
![compute](../../../concepts/taskrunner-gcp-batch/compute.png)
...
![bucket](../../../concepts/taskrunner-gcp-batch/bucket.png)
...
![logs](../../../concepts/taskrunner-gcp-batch/logs.png)

We can also go to the GCP Console and see our task runner has been created:

![batch-jobs](../../../concepts/taskrunner-gcp-batch/batch-jobs.png)
...
![outputs](../../../concepts/taskrunner-gcp-batch/outputs.png)
