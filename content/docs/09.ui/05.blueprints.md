...
:::alert{type="info"}
Custom blueprints require the [Enterprise Edition](../../07.enterprise/index.md).
:::

![Custom Blueprints](/docs/user-interface-guide/custom-blueprint.png)

Check the [Blueprints documentation](../06.concepts/07.blueprints.md) for more details.
