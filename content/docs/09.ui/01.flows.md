...
The **Files** view allows you to create, edit and delete [Namespaces Files](../05.concepts/02.namespace-files.md). Multiple files can be opened at the same time, as well as displayed side by side using multiple panels.
