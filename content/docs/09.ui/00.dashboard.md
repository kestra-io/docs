...
![Dashboard Main Page](/docs/enterprise/dashboards/main_page.png)
...
:::alert{type="info"}
Check out the [No-Code Dashboards guide](../no-code/02.no-code-dashboards.md) to know more about building Dashboards without touching YAML.
:::
...
![Dashboard Table Export](/docs/enterprise/dashboards/dashboard-table-export.png)
...
| `labelKey` | Defines the key of the [source label](../05.workflow-components/08.labels.md), applicable when `field: LABELS` is specified. |
