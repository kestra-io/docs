...
- [namespace-level secrets](../02.governance/secrets.md)
- [namespace-level variables](../02.governance/07.namespace-management.md#namespace-level-features-secrets-variables-and-plugin-defaults) which values can be accessed through `{{ namespace.my_variable_name }}`
- [namespace-level plugin defaults](../02.governance/08.centralized-task-configuration.md).
...
For detailed instructions, refer to [centralized task configuration](../02.governance/08.centralized-task-configuration.md).
