...
To authenticate with the Kestra API, you will need to create an [API token](../../06.enterprise/03.auth-rbac-user-management/api-tokens.md). You can create it directly from the Kestra UI.
