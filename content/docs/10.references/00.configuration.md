...
To enable the PostgreSQL database repository, you need to add the following to your configuration file:
...
By default, the `kestra.anonymous-usage-report` is enabled. It sends anonymous usage data to Kestra to help us improve the product.
...
Read more about telemetry usage [here](../09.administrator-guide/usage.md).
...
As Kestra is a Java-based application built with Micronaut, you can configure any Micronaut configuration options using the `micronaut` configuration.
