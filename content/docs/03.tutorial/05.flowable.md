...
While simple, the example demonstrates the flexibility provided by flowable tasks in both simple and complex workflows. To learn more about flowable tasks and more examples, check out the full [flowable tasks documentation](../04.workflow-components/01.tasks/00.flowable-tasks.md).
