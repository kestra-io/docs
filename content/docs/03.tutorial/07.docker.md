...
- [Script tasks](../08.developer-guide/scripts/index.md) running Python, Node.js, R, Julia, Bash, and more
...
For more examples of running scripts in Docker containers, check the [Script tasks](../08.developer-guide/scripts/index.md) page.
