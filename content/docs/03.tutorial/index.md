...
This tutorial will guide you through **key concepts** in Kestra. We'll start with the same "Hello world" flow from the [Quickstart Guide](/docs/getting-started/quickstart), and we'll gradually introduce new concepts including `namespaces`, `tasks`, parametrization with `inputs` and scheduling using `triggers`.
...
::next-link
[Fundamentals: build a "Hello World" flow](/docs/tutorial/fundamentals)
::
