...
By default, if any task fails, the execution stops and is marked as failed.
...
The following example workflow automatically sends a Slack alert via the [SlackIncomingWebhook](/plugins/plugin-notifications/slack/io.kestra.plugin.slack.slackincomingwebhook) whenever any flow in the `company.team` namespace fails or finishes with warnings.
...
Check the [error handling](../05.workflow-components/11.errors.md) page for more details.
...
- [Slack](/plugins/plugin-notifications/slack/io.kestra.plugin.slack.slackexecution)
- [Microsoft Teams](/plugins/plugin-notifications/teams/io.kestra.plugin.microsoft365.teams.teamsexecution)
- [Email](/plugins/plugin-notifications/mail/io.kestra.plugin.email.mailexecution)
