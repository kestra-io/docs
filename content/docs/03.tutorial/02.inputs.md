...
Inputs can be accessed in any task using the following [expression](../07.concepts/06.expressions/01.index.md) `{{ inputs.input_name }}`.
...
Check the [inputs documentation](../07.concepts/inputs.md) for a full list of supported input types.
