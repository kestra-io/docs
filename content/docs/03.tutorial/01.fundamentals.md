...
:::alert{type="info"}
If you haven't already, to install Kestra, follow the [Quickstart Guide](../01.quickstart/index.md) or check the detailed [Installation Guide](../02.installation/index.md).
:::
