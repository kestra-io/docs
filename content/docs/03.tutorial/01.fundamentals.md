...
[Flows](../06.workflow-components/02.flow/index.md) are defined in a declarative YAML syntax to keep the orchestration code portable and language-agnostic.
...
You can optionally add a [description](../06.workflow-components/15.descriptions.md) property to keep your flows documented. The `description` is a string that supports **markdown** syntax. That markdown description will be rendered and displayed in the UI.
...
Learn more about flows in the [Flows section](../06.workflow-components/02.flow/index.md).
