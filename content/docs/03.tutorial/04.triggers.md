...
# Automate Kestra Flows with Triggers
...
To learn more about Triggers, check out the full [Triggers documentation](../05.workflow-components/07.triggers/index.md). Next up, we'll check out Flowable tasks – ways to loop, condition, and parallelize tasks.
