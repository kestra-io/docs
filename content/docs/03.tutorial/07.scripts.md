...
Script tasks run scripts in Docker containers or local processes. You can run Python, Node.js, R, Julia, or other scripts, or execute commands in shell or PowerShell.
