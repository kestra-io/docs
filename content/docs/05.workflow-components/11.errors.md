...
The example below sends a flow-level failure alert via Slack using the [SlackIncomingWebhook](/plugins/plugin-notifications/slack/io.kestra.plugin.slack.slackincomingwebhook) task defined using the `errors` property.
