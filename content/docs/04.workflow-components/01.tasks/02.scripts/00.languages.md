...
For handling outputs and metrics, you can use the same approach that the `Shell` task uses by using `::{}::` syntax in log messages. Read more about it [here](06.outputs-metrics.md#shell).
...
![golang_output](../../../../developer-guide/scripts/golang_output.png)
...
![rust_output](../../../../developer-guide/scripts/rust_output.png)
...
![java_output](../../../../developer-guide/scripts/java_output.png)
...
![c_output](../../../../developer-guide/scripts/c_output.png)
...
![cpp_output](../../../../developer-guide/scripts/cpp_output.png)
...
![ts_output](../../../../developer-guide/scripts/ts_output.png)

You can read more about Node.js with TypeScript [here](https://nodejs.org/en/learn/getting-started/nodejs-with-typescript).
...
![php_output](../../../../developer-guide/scripts/php_output.png)
...
![scala_output](../../../../developer-guide/scripts/scala_output.png)
...
![perl_output](../../../../developer-guide/scripts/perl_output.png)
