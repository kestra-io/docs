...
You can build [custom plugins](../../../plugin-developer-guide/index.md) in Java which will allow you to add custom tasks to your workflows. If you're looking to execute something simpler, you can use the `Shell` task with a Docker container.
