...
If your Kestra instance is set up with the [Kafka and Elasticsearch backend](../../07.architecture/index.md#architecture-with-kafka-and-elasticsearch-backend), you can view Task Runs directly in the UI.
