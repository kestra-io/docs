...
![task_outputs_example](../../workflow-components/outputs/task_outputs_example.png)
...
![taskrun_value_example](../../workflow-components/outputs/taskrun_value_example.png)
...
![preview_button](../../workflow-components/outputs/preview_button.png)
...
![preview](../../workflow-components/outputs/preview.png)
...
![json_values](../../workflow-components/outputs/json_values.png)

You can select the task from the drop-down menu. Here, we will select "sample_json" and select **Debug Outputs**:

![json_values_render_expression](../../workflow-components/outputs/json_values_render_expression.png)

You can now use pebble expressions and evaluate different expressions based on the output data to analyse it further.

![json_values_render_expression_sample](../../workflow-components/outputs/json_values_render_expression_sample.png)
