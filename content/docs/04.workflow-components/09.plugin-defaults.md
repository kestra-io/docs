...
In the `pluginDefaults`, if you set `forced: true`, the plugin default will take precedence over properties defined in the task. Be default, the value of `forced` attribute is `false`.
