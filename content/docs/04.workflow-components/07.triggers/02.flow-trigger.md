...
You can provide conditions to determine when your Flow should be executed. Along with the [core trigger conditions](../triggers#conditions), you can use the following:
