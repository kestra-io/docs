...
Kestra supports version control with Git. You can use one or more repositories to store your [flows](../04.workflow-components/01.flow.md), [namespace files](../05.concepts/02.namespace-files.md), [apps](../06.enterprise/04.scalability/apps.md), [tests](../06.enterprise/02.governance/unit-tests.md), and [dashboards](../08.ui/00.dashboard.md), tracking changes through Git history.
...
You can also trigger this flow with a [GitHub webhook](../04.workflow-components/07.triggers/03.webhook-trigger.md) whenever changes land in Git:
