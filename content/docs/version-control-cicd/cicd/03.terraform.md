...
:::alert{type="info"}
For flows managed through CI/CD or infrastructure-as-code, add the [`system.readOnly`](../../05.concepts/06.system-labels.md#systemreadonly) label set to `"true"` so the UI editor is disabled and production configurations stay immutable. This is especially recommended for critical production flows:
...
- Integrate Terraform into your [CI/CD pipeline](../developer-guide/ci-cd/index.md) for automated deployments.
