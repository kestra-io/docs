...
If you launch Kestra from our Docker Compose file, as explained in the [Getting Started](../00.getting-started/index.md) guide, it will be available on http://localhost:8080.
