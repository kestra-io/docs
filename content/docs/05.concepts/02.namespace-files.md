...
::alert{type="info"}
In version 0.24, we introduced a universal file protocol that simplifies accessing files—local or namespace—in your flow. Refer to the [File Access documentation page](file-access.md) for more details.
::
