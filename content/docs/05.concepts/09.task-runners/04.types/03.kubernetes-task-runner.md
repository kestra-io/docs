  ...
  - id: shell
    ...
    taskRunner:
      ...
      config:
        ...
        masterUrl: https://cluster-external-endpoint
        username: gke_projectid_region_clustername
...
Once you've run this command, you can now access your config with `kubectl config view --minify --flatten`.
