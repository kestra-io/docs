...
![project_selection](/docs/concepts/taskrunner-gcp-batch/project_selection.png)
...
We can also view the outputs generated in the Outputs tab in Kestra, which contains information about the Google Batch task runner:
