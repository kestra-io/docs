...
You can use the value of the input `my-string` inside dynamic task properties with `{{ inputs['my-string'] }}`. See more in the [using expressions](06.expressions/02b.using-expressions.md) section.
