...
Additionally, you can organize your code on a namespace-level using the embedded VS Code editor and [Namespace Files](../08.developer-guide/03.namespace-files), with the option to [sync those files from Git](../08.developer-guide/04.git):
