...
![Namespace file revision history](/docs/concepts/namespace-files/namespace-file-revision-history.png)

From the history, view, compare, and restore prior versions.

![Restore namespace file revision placeholder](/docs/concepts/namespace-files/namespace-file-restore.png)
...
:::alert{type="info"}
When creating a service account role for the GitHub Action in the [Enterprise Edition](../07.enterprise/index.md), you need to grant the `FLOWS` permission to the Role.
