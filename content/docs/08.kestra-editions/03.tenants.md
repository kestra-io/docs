...
Regardless of which of the above methods you use to create a tenant, the Kestra User who creates the tenant will automatically get the [Tenant Admin Role](../../../08.kestra-editions/RBAC/02.admins.md) assigned. That role grants admin rights to that user on that tenant.

---

## How to Enable Multi-Tenancy

By default, multi-tenancy is disabled in the [Enterprise Edition](01.enterprise.md)]. Add the following configuration to enable multi-tenancy:
