...
Read more about [Tenants](../../06.enterprise/03.tenants.md).
...
Similar to Users, you can create [Service Accounts](../../06.enterprise/service-accounts.md). The difference is you can't select an Authentication Method - instead you must use an API Token.
...
When you create a new role, you can select the appropriate permissions and which level they should be. More information on RBAC, check out the [permissions](../../06.enterprise/rbac.md#permissions) documentation.
