...
In the **Namespace Context** view, you can directly access in the editor: Variables, KV pairs, and Secrets — essential for managing dynamic values, key-value data, and sensitive credentials securely. You can also render expressions that fall within those categories.
