...
Some firewall rules might need to be adjusted to allow communication with Microsoft's VS Code editor. Check the [Network Connections in Visual Studio Code](https://code.visualstudio.com/docs/setup/network) for more information.
