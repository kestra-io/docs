...
::alert{type="warning"}
Running the jar version will come without any [plugins](../https://kestra.io/plugins), you must install it manually with [install](../01.configuration/04.others.md#plugins-configuration) command
::
