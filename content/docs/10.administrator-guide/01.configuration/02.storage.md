...
Kestra needs an [internal storage](../../07.concepts/internal-storage.md) to store data processed by tasks. This includes files from flow inputs and data stored as task outputs.
