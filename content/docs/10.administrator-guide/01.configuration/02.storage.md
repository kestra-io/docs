...
Kestra needs an [internal storage](../../04.architecture/internal-storage.md) to store data processed by tasks. This includes files from flow inputs and data stored as task outputs.
