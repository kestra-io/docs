...
By default, [deprecated handlebars](../../07.concepts/06.expressions/08.deprecated-handlebars/index.md) is disabled, it can be enabled by setting this option to `true`.
