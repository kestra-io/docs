...
Here is an example of how to use the [TemplatedTask](https://kestra.io/plugins/tasks/templating/io.kestra.plugin.core.templating.TemplatedTask) to create a Databricks job using dynamic properties:
