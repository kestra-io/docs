...
- **New UI features**
  - the Editor display has been revamped, improving the visibility of the Editor options as well as the `Save` and `Actions` buttons
...
- **Plugin library expansion**
  ...
  - new generic Singer plugin let easily use _all_ Singer taps and targets
