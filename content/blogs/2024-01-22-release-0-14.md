...
We've heard from many of you that you'd like to use Git to [version control](https://kestra.io/docs/architecture/server-components") your workflows. This release adds two new tasks to the [Git plugin](/plugins/plugin-git) that allow you to sync your code from Git to Kestra and push your code from Kestra to Git.
...
Check the [Git Sync](https://kestra.io"/docs/architecture/server-components"-sync) documentation for more details.
...
Check the [Version Control with Git](https://kestra.io"/docs/architecture/server-components") documentation for a deep dive into multiple ways to version control your code with Git and when to use them.
