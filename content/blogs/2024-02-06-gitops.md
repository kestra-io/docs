...
- [Namespace Files](https://kestra.io/docs/concepts/namespace-files): Kestra offers an embedded Code editor where you can store any kind of files. This is very useful when you want to inject custom scripts into your orchestration layer without the burden of having an unreadable YAML file.
