---
title: Kestra 0.18 brings Namespaces and KV Store to Open-Source, SCIM Provisioning and SQL Server backend to Enterprise, and new Outputs UI to both!
...
| **Namespaces**                   | The improved Namespace Overview, now available also in the Open Source version, provides a comprehensive view of all namespaces used in your flows without having to create those namespace manually.                                             | Both Open-Source and Enterprise  | [Link](/docs/workflow-components/namespace)                 |
