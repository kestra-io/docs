...
Task Runners in Kestra 0.18.0 offer a more resilient file handling and more stability when recovering from failure in remote compute environments. Read more about Task Runners in our [Documentation](../docs/05.concepts/09.task-runners/index.md).
