...
If your flow takes a PDF file as input, you can now add `extension: .pdf` to preview the `FILE`-type input as a PDF in the UI.
...
tasks:
  - id: hello
    type: io.kestra.plugin.core.log.Log
    message: The Preview in the Overview tab will display a PDF preview
```

Big thanks to [Yuri](https://github.com/kestra-io/kestra/pull/4157) for contributing this feature!

### Human-readable schedules

The UI now displays CRON schedules in a human-readable format, making it easier to understand when your executions are scheduled to run.
...
Also here, big thanks to [Yuri](https://github.com/kestra-io/kestra/issues/4211) for contributing this super useful enhancement!
...
description: |
  This flow will download the latest dbt project from a Git repository and upload it to the Kestra instance.
