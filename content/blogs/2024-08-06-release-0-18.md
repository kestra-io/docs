...
We have also added the `Editor` tab to the `Namespace` page, offering one more place from where you can access and manage [Namespace Files](https://kestra.io/docs/concepts/namespace-files).
