...
|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|-------------------------------------------------------------|
| **KV Store**                     | This major addition to Kestra's orchestration capabilities allows you to **store and retrieve key-value pairs** in tasks and triggers, enabling new use cases and bringing statefulness to otherwise stateless workflow execution. | Both Open-Source and Enterprise  | [Link](../docs/05.concepts/05.kv-store.md)                             |
