...
Below, you can see an example of a vacation approval process that uses the Pause task to pause the workflow execution and wait for vacation approval from a manager. The user can approve or reject the request and provide a reason for that decision.
