...
🔹 [Namespace Files](https://kestra.io/docs/concepts/namespace-files) and the `read()` function, enabling the orchestration of custom scripts and microservices with modular components
...
This feature not only makes your work more efficient but also brings your YAML definitions together with your scripts, microservices, custom queries, and other project files (called [Namespace Files](https://kestra.io/docs/concepts/namespace-files)) into a single, streamlined interface.
